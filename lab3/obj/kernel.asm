...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	304040ef          	jal	ra,ffffffffc020434e <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	32a58593          	addi	a1,a1,810 # ffffffffc0204378 <etext>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	34250513          	addi	a0,a0,834 # ffffffffc0204398 <etext+0x20>
...
ffffffffc020006e:	5b0030ef          	jal	ra,ffffffffc020361e <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	5ef030ef          	jal	ra,ffffffffc0203e9c <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	5b9030ef          	jal	ra,ffffffffc0203e9c <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	29c50513          	addi	a0,a0,668 # ffffffffc02043a0 <etext+0x28>
void print_kerninfo(void) {
...
ffffffffc020011e:	2a650513          	addi	a0,a0,678 # ffffffffc02043c0 <etext+0x48>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	25258593          	addi	a1,a1,594 # ffffffffc0204378 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	2b250513          	addi	a0,a0,690 # ffffffffc02043e0 <etext+0x68>
...
ffffffffc0200146:	2be50513          	addi	a0,a0,702 # ffffffffc0204400 <etext+0x88>
...
ffffffffc020015a:	2ca50513          	addi	a0,a0,714 # ffffffffc0204420 <etext+0xa8>
...
ffffffffc0200188:	2bc50513          	addi	a0,a0,700 # ffffffffc0204440 <etext+0xc8>
}
...
ffffffffc0200196:	2de60613          	addi	a2,a2,734 # ffffffffc0204470 <etext+0xf8>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	2ea50513          	addi	a0,a0,746 # ffffffffc0204488 <etext+0x110>
void print_stackframe(void) {
...
ffffffffc02001b2:	2f260613          	addi	a2,a2,754 # ffffffffc02044a0 <etext+0x128>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	30a58593          	addi	a1,a1,778 # ffffffffc02044c0 <etext+0x148>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	30a50513          	addi	a0,a0,778 # ffffffffc02044c8 <etext+0x150>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	30c60613          	addi	a2,a2,780 # ffffffffc02044d8 <etext+0x160>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	32c58593          	addi	a1,a1,812 # ffffffffc0204500 <etext+0x188>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	2ec50513          	addi	a0,a0,748 # ffffffffc02044c8 <etext+0x150>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	32860613          	addi	a2,a2,808 # ffffffffc0204510 <etext+0x198>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	34058593          	addi	a1,a1,832 # ffffffffc0204530 <etext+0x1b8>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	2d050513          	addi	a0,a0,720 # ffffffffc02044c8 <etext+0x150>
...
ffffffffc0200236:	30e50513          	addi	a0,a0,782 # ffffffffc0204540 <etext+0x1c8>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	31450513          	addi	a0,a0,788 # ffffffffc0204568 <etext+0x1f0>
...
ffffffffc020026e:	366c0c13          	addi	s8,s8,870 # ffffffffc02045d0 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00005917          	auipc	s2,0x5
ffffffffc0200276:	76e90913          	addi	s2,s2,1902 # ffffffffc02059e0 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	31648493          	addi	s1,s1,790 # ffffffffc0204590 <etext+0x218>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	314b0b13          	addi	s6,s6,788 # ffffffffc0204598 <etext+0x220>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	234a0a13          	addi	s4,s4,564 # ffffffffc02044c0 <etext+0x148>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	787030ef          	jal	ra,ffffffffc020421e <readline>
...
ffffffffc02002b2:	322d0d13          	addi	s10,s10,802 # ffffffffc02045d0 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	05e040ef          	jal	ra,ffffffffc020431a <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	04a040ef          	jal	ra,ffffffffc020431a <strcmp>
...
ffffffffc020030e:	02a040ef          	jal	ra,ffffffffc0204338 <strchr>
...
ffffffffc020034c:	7ed030ef          	jal	ra,ffffffffc0204338 <strchr>
...
ffffffffc020036a:	25250513          	addi	a0,a0,594 # ffffffffc02045b8 <etext+0x240>
...
ffffffffc02003a6:	27650513          	addi	a0,a0,630 # ffffffffc0204618 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	17850513          	addi	a0,a0,376 # ffffffffc0205530 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	24250513          	addi	a0,a0,578 # ffffffffc0204638 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	6a9030ef          	jal	ra,ffffffffc0204360 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	685030ef          	jal	ra,ffffffffc0204360 <memcpy>
    return 0;
}
...
ffffffffc0200528:	13450513          	addi	a0,a0,308 # ffffffffc0204658 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	6ae0306f          	j	ffffffffc0203bf6 <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	12c60613          	addi	a2,a2,300 # ffffffffc0204678 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	13850513          	addi	a0,a0,312 # ffffffffc0204690 <commands+0xc0>
...
ffffffffc020058e:	11e50513          	addi	a0,a0,286 # ffffffffc02046a8 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	24e50513          	addi	a0,a0,590 # ffffffffc0204990 <commands+0x3c0>
}
...
ffffffffc020075a:	25250513          	addi	a0,a0,594 # ffffffffc02049a8 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	25250513          	addi	a0,a0,594 # ffffffffc02049c0 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	25a50513          	addi	a0,a0,602 # ffffffffc02049d8 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	26250513          	addi	a0,a0,610 # ffffffffc02049f0 <commands+0x420>
...
ffffffffc02007a6:	26650513          	addi	a0,a0,614 # ffffffffc0204a08 <commands+0x438>
}
...
ffffffffc02007c2:	31270713          	addi	a4,a4,786 # ffffffffc0204ad0 <commands+0x500>
...
ffffffffc02007d4:	2b050513          	addi	a0,a0,688 # ffffffffc0204a80 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	28450513          	addi	a0,a0,644 # ffffffffc0204a60 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	23850513          	addi	a0,a0,568 # ffffffffc0204a20 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	24c50513          	addi	a0,a0,588 # ffffffffc0204a40 <commands+0x470>
...
ffffffffc020082a:	28a50513          	addi	a0,a0,650 # ffffffffc0204ab0 <commands+0x4e0>
...
ffffffffc020083e:	26650513          	addi	a0,a0,614 # ffffffffc0204aa0 <commands+0x4d0>
}
...
ffffffffc0200860:	45c70713          	addi	a4,a4,1116 # ffffffffc0204cb8 <commands+0x6e8>
...
ffffffffc0200872:	43250513          	addi	a0,a0,1074 # ffffffffc0204ca0 <commands+0x6d0>
...
ffffffffc0200894:	27050513          	addi	a0,a0,624 # ffffffffc0204b00 <commands+0x530>
}
...
ffffffffc02008a8:	27c50513          	addi	a0,a0,636 # ffffffffc0204b20 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	29250513          	addi	a0,a0,658 # ffffffffc0204b40 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	2a050513          	addi	a0,a0,672 # ffffffffc0204b58 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	2a650513          	addi	a0,a0,678 # ffffffffc0204b68 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	2bc50513          	addi	a0,a0,700 # ffffffffc0204b88 <commands+0x5b8>
...
ffffffffc02008ee:	2b660613          	addi	a2,a2,694 # ffffffffc0204ba0 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	d9a50513          	addi	a0,a0,-614 # ffffffffc0204690 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	2be50513          	addi	a0,a0,702 # ffffffffc0204bc0 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	2cc50513          	addi	a0,a0,716 # ffffffffc0204bd8 <commands+0x608>
...
ffffffffc0200998:	20c60613          	addi	a2,a2,524 # ffffffffc0204ba0 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	cf050513          	addi	a0,a0,-784 # ffffffffc0204690 <commands+0xc0>
...
ffffffffc02009c4:	1e060613          	addi	a2,a2,480 # ffffffffc0204ba0 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	cc450513          	addi	a0,a0,-828 # ffffffffc0204690 <commands+0xc0>
...
ffffffffc0200b6e:	5e65b583          	ld	a1,1510(a1) # ffffffffc0206150 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	5e263603          	ld	a2,1506(a2) # ffffffffc0206158 <nbase>
...
ffffffffc0200dc6:	f3668693          	addi	a3,a3,-202 # ffffffffc0204cf8 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	f3e60613          	addi	a2,a2,-194 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	f4a50513          	addi	a0,a0,-182 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	fd668693          	addi	a3,a3,-42 # ffffffffc0204db8 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	f1e60613          	addi	a2,a2,-226 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	f2a50513          	addi	a0,a0,-214 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	fde68693          	addi	a3,a3,-34 # ffffffffc0204de0 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	efe60613          	addi	a2,a2,-258 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	f0a50513          	addi	a0,a0,-246 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	ffe68693          	addi	a3,a3,-2 # ffffffffc0204e20 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	ede60613          	addi	a2,a2,-290 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	eea50513          	addi	a0,a0,-278 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	06668693          	addi	a3,a3,102 # ffffffffc0204ea8 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	ebe60613          	addi	a2,a2,-322 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	eca50513          	addi	a0,a0,-310 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	ef668693          	addi	a3,a3,-266 # ffffffffc0204d58 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	e9e60613          	addi	a2,a2,-354 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	eaa50513          	addi	a0,a0,-342 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	01668693          	addi	a3,a3,22 # ffffffffc0204e98 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	e7e60613          	addi	a2,a2,-386 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	e8a50513          	addi	a0,a0,-374 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	fde68693          	addi	a3,a3,-34 # ffffffffc0204e80 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	e5e60613          	addi	a2,a2,-418 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	e6a50513          	addi	a0,a0,-406 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	f9e68693          	addi	a3,a3,-98 # ffffffffc0204e60 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	e3e60613          	addi	a2,a2,-450 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	e4a50513          	addi	a0,a0,-438 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	00e68693          	addi	a3,a3,14 # ffffffffc0204ef0 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	e1e60613          	addi	a2,a2,-482 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	e2a50513          	addi	a0,a0,-470 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	fde68693          	addi	a3,a3,-34 # ffffffffc0204ee0 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	dfe60613          	addi	a2,a2,-514 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	e0a50513          	addi	a0,a0,-502 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	f5e68693          	addi	a3,a3,-162 # ffffffffc0204e80 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	dde60613          	addi	a2,a2,-546 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	dea50513          	addi	a0,a0,-534 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	f7e68693          	addi	a3,a3,-130 # ffffffffc0204ec0 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	dbe60613          	addi	a2,a2,-578 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	dca50513          	addi	a0,a0,-566 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	df668693          	addi	a3,a3,-522 # ffffffffc0204d58 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	d9e60613          	addi	a2,a2,-610 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	daa50513          	addi	a0,a0,-598 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	efe68693          	addi	a3,a3,-258 # ffffffffc0204e80 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	d7e60613          	addi	a2,a2,-642 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	d8a50513          	addi	a0,a0,-630 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	df668693          	addi	a3,a3,-522 # ffffffffc0204d98 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	d5e60613          	addi	a2,a2,-674 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	d6a50513          	addi	a0,a0,-662 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	db668693          	addi	a3,a3,-586 # ffffffffc0204d78 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	d3e60613          	addi	a2,a2,-706 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	d4a50513          	addi	a0,a0,-694 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	db668693          	addi	a3,a3,-586 # ffffffffc0204d98 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	d1e60613          	addi	a2,a2,-738 # ffffffffc0204d08 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	d2a50513          	addi	a0,a0,-726 # ffffffffc0204d20 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	03e68693          	addi	a3,a3,62 # ffffffffc0205040 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	cfe60613          	addi	a2,a2,-770 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	d0a50513          	addi	a0,a0,-758 # ffffffffc0204d20 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	ebe68693          	addi	a3,a3,-322 # ffffffffc0204ee0 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	cde60613          	addi	a2,a2,-802 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	cea50513          	addi	a0,a0,-790 # ffffffffc0204d20 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	e3e68693          	addi	a3,a3,-450 # ffffffffc0204e80 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	cbe60613          	addi	a2,a2,-834 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	cca50513          	addi	a0,a0,-822 # ffffffffc0204d20 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	dde68693          	addi	a3,a3,-546 # ffffffffc0204e40 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	c9e60613          	addi	a2,a2,-866 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	caa50513          	addi	a0,a0,-854 # ffffffffc0204d20 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	f7e68693          	addi	a3,a3,-130 # ffffffffc0205000 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	c7e60613          	addi	a2,a2,-898 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	c8a50513          	addi	a0,a0,-886 # ffffffffc0204d20 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	f3e68693          	addi	a3,a3,-194 # ffffffffc0204fe0 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	c5e60613          	addi	a2,a2,-930 # ffffffffc0204d08 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	c6a50513          	addi	a0,a0,-918 # ffffffffc0204d20 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	ef668693          	addi	a3,a3,-266 # ffffffffc0204fb8 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	c3e60613          	addi	a2,a2,-962 # ffffffffc0204d08 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	c4a50513          	addi	a0,a0,-950 # ffffffffc0204d20 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	eae68693          	addi	a3,a3,-338 # ffffffffc0204f90 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	c1e60613          	addi	a2,a2,-994 # ffffffffc0204d08 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	c2a50513          	addi	a0,a0,-982 # ffffffffc0204d20 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	e7e68693          	addi	a3,a3,-386 # ffffffffc0204f80 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	bfe60613          	addi	a2,a2,-1026 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	c0a50513          	addi	a0,a0,-1014 # ffffffffc0204d20 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	d5e68693          	addi	a3,a3,-674 # ffffffffc0204e80 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	bde60613          	addi	a2,a2,-1058 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	bea50513          	addi	a0,a0,-1046 # ffffffffc0204d20 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	e1e68693          	addi	a3,a3,-482 # ffffffffc0204f60 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	bbe60613          	addi	a2,a2,-1090 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	bca50513          	addi	a0,a0,-1078 # ffffffffc0204d20 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	dce68693          	addi	a3,a3,-562 # ffffffffc0204f30 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	b9e60613          	addi	a2,a2,-1122 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	baa50513          	addi	a0,a0,-1110 # ffffffffc0204d20 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	d9668693          	addi	a3,a3,-618 # ffffffffc0204f18 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	b7e60613          	addi	a2,a2,-1154 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	b8a50513          	addi	a0,a0,-1142 # ffffffffc0204d20 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	cde68693          	addi	a3,a3,-802 # ffffffffc0204e80 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	b5e60613          	addi	a2,a2,-1186 # ffffffffc0204d08 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	b6a50513          	addi	a0,a0,-1174 # ffffffffc0204d20 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	d3e68693          	addi	a3,a3,-706 # ffffffffc0204f00 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	b3e60613          	addi	a2,a2,-1218 # ffffffffc0204d08 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	b4a50513          	addi	a0,a0,-1206 # ffffffffc0204d20 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	e3e68693          	addi	a3,a3,-450 # ffffffffc0205020 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	b1e60613          	addi	a2,a2,-1250 # ffffffffc0204d08 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	b2a50513          	addi	a0,a0,-1238 # ffffffffc0204d20 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	e4e68693          	addi	a3,a3,-434 # ffffffffc0205050 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	afe60613          	addi	a2,a2,-1282 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	b0a50513          	addi	a0,a0,-1270 # ffffffffc0204d20 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	b1668693          	addi	a3,a3,-1258 # ffffffffc0204d38 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	ade60613          	addi	a2,a2,-1314 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	aea50513          	addi	a0,a0,-1302 # ffffffffc0204d20 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	b3668693          	addi	a3,a3,-1226 # ffffffffc0204d78 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	abe60613          	addi	a2,a2,-1346 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	aca50513          	addi	a0,a0,-1334 # ffffffffc0204d20 <commands+0x750>
...
ffffffffc020139e:	cce68693          	addi	a3,a3,-818 # ffffffffc0205068 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	96660613          	addi	a2,a2,-1690 # ffffffffc0204d08 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	97250513          	addi	a0,a0,-1678 # ffffffffc0204d20 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	ca668693          	addi	a3,a3,-858 # ffffffffc0205060 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	94660613          	addi	a2,a2,-1722 # ffffffffc0204d08 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	95250513          	addi	a0,a0,-1710 # ffffffffc0204d20 <commands+0x750>
...
ffffffffc0201476:	bee68693          	addi	a3,a3,-1042 # ffffffffc0205060 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	88e60613          	addi	a2,a2,-1906 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	89a50513          	addi	a0,a0,-1894 # ffffffffc0204d20 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	b4868693          	addi	a3,a3,-1208 # ffffffffc0205090 <commands+0xac0>
ffffffffc0201550:	00003617          	auipc	a2,0x3
ffffffffc0201554:	7b860613          	addi	a2,a2,1976 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00003517          	auipc	a0,0x3
ffffffffc0201560:	7c450513          	addi	a0,a0,1988 # ffffffffc0204d20 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	af868693          	addi	a3,a3,-1288 # ffffffffc0205060 <commands+0xa90>
ffffffffc0201570:	00003617          	auipc	a2,0x3
ffffffffc0201574:	79860613          	addi	a2,a2,1944 # ffffffffc0204d08 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00003517          	auipc	a0,0x3
ffffffffc0201580:	7a450513          	addi	a0,a0,1956 # ffffffffc0204d20 <commands+0x750>
...
ffffffffc020158e:	b6660613          	addi	a2,a2,-1178 # ffffffffc02050f0 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0205110 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	b7a60613          	addi	a2,a2,-1158 # ffffffffc0205120 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	b5e50513          	addi	a0,a0,-1186 # ffffffffc0205110 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201722:	a32b3b03          	ld	s6,-1486(s6) # ffffffffc0206150 <error_string+0x38>
...
ffffffffc0201760:	3ef020ef          	jal	ra,ffffffffc020434e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	984b3b03          	ld	s6,-1660(s6) # ffffffffc0206150 <error_string+0x38>
...
ffffffffc0201802:	34d020ef          	jal	ra,ffffffffc020434e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	8ea60613          	addi	a2,a2,-1814 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	90650513          	addi	a0,a0,-1786 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	8d260613          	addi	a2,a2,-1838 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	8ee50513          	addi	a0,a0,-1810 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	8b860613          	addi	a2,a2,-1864 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	8d450513          	addi	a0,a0,-1836 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	89e60613          	addi	a2,a2,-1890 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	8ba50513          	addi	a0,a0,-1862 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	75c43403          	ld	s0,1884(s0) # ffffffffc0206150 <error_string+0x38>
...
ffffffffc0201aba:	60278793          	addi	a5,a5,1538 # ffffffffc02050b8 <default_pmm_manager>
...
ffffffffc0201ac8:	6bc50513          	addi	a0,a0,1724 # ffffffffc0205180 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	67850513          	addi	a0,a0,1656 # ffffffffc0205198 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	69850513          	addi	a0,a0,1688 # ffffffffc02051c8 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	69650513          	addi	a0,a0,1686 # ffffffffc02051e0 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	65a50513          	addi	a0,a0,1626 # ffffffffc0205230 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	356cbc83          	ld	s9,854(s9) # ffffffffc0206150 <error_string+0x38>
...
ffffffffc0201ea2:	67a50513          	addi	a0,a0,1658 # ffffffffc0205518 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	6fc58593          	addi	a1,a1,1788 # ffffffffc0205650 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	3a8020ef          	jal	ra,ffffffffc0204308 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	3ae020ef          	jal	ra,ffffffffc020431a <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	32c020ef          	jal	ra,ffffffffc02042d2 <strlen>
...
ffffffffc020209c:	63050513          	addi	a0,a0,1584 # ffffffffc02056c8 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	3da68693          	addi	a3,a3,986 # ffffffffc0205578 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	b6260613          	addi	a2,a2,-1182 # ffffffffc0204d08 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	fbe50513          	addi	a0,a0,-66 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	37a68693          	addi	a3,a3,890 # ffffffffc0205538 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	b4260613          	addi	a2,a2,-1214 # ffffffffc0204d08 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	f9e50513          	addi	a0,a0,-98 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	f6860613          	addi	a2,a2,-152 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	f8450513          	addi	a0,a0,-124 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	00c60613          	addi	a2,a2,12 # ffffffffc0205208 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	f6850513          	addi	a0,a0,-152 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	ff460613          	addi	a2,a2,-12 # ffffffffc0205208 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	f5050513          	addi	a0,a0,-176 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	04468693          	addi	a3,a3,68 # ffffffffc0205270 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	ad460613          	addi	a2,a2,-1324 # ffffffffc0204d08 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	f3050513          	addi	a0,a0,-208 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	00468693          	addi	a3,a3,4 # ffffffffc0205250 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	ab460613          	addi	a2,a2,-1356 # ffffffffc0204d08 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	f1050513          	addi	a0,a0,-240 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	09068693          	addi	a3,a3,144 # ffffffffc0205300 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	a9060613          	addi	a2,a2,-1392 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	eec50513          	addi	a0,a0,-276 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	04068693          	addi	a3,a3,64 # ffffffffc02052d0 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	a7060613          	addi	a2,a2,-1424 # ffffffffc0204d08 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	ecc50513          	addi	a0,a0,-308 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	ff868693          	addi	a3,a3,-8 # ffffffffc02052a8 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	a5060613          	addi	a2,a2,-1456 # ffffffffc0204d08 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	eac50513          	addi	a0,a0,-340 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	0b868693          	addi	a3,a3,184 # ffffffffc0205388 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	a3060613          	addi	a2,a2,-1488 # ffffffffc0204d08 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	e8c50513          	addi	a0,a0,-372 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	13868693          	addi	a3,a3,312 # ffffffffc0205428 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	a1060613          	addi	a2,a2,-1520 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	e6c50513          	addi	a0,a0,-404 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	05068693          	addi	a3,a3,80 # ffffffffc0205360 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	9f060613          	addi	a2,a2,-1552 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	e4c50513          	addi	a0,a0,-436 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	e1660613          	addi	a2,a2,-490 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	e3250513          	addi	a0,a0,-462 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	07668693          	addi	a3,a3,118 # ffffffffc02053c0 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	9b660613          	addi	a2,a2,-1610 # ffffffffc0204d08 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	e1250513          	addi	a0,a0,-494 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	11e68693          	addi	a3,a3,286 # ffffffffc0205488 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	99660613          	addi	a2,a2,-1642 # ffffffffc0204d08 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	df250513          	addi	a0,a0,-526 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	0e668693          	addi	a3,a3,230 # ffffffffc0205470 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	97660613          	addi	a2,a2,-1674 # ffffffffc0204d08 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	dd250513          	addi	a0,a0,-558 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	09668693          	addi	a3,a3,150 # ffffffffc0205440 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	95660613          	addi	a2,a2,-1706 # ffffffffc0204d08 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	db250513          	addi	a0,a0,-590 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	22e68693          	addi	a3,a3,558 # ffffffffc02055f8 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	93660613          	addi	a2,a2,-1738 # ffffffffc0204d08 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	d9250513          	addi	a0,a0,-622 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	02668693          	addi	a3,a3,38 # ffffffffc0205410 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	91660613          	addi	a2,a2,-1770 # ffffffffc0204d08 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	d7250513          	addi	a0,a0,-654 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	ff668693          	addi	a3,a3,-10 # ffffffffc0205400 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	8f660613          	addi	a2,a2,-1802 # ffffffffc0204d08 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	d5250513          	addi	a0,a0,-686 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	0ce68693          	addi	a3,a3,206 # ffffffffc02054f8 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	8d660613          	addi	a2,a2,-1834 # ffffffffc0204d08 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	d3250513          	addi	a0,a0,-718 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	fa668693          	addi	a3,a3,-90 # ffffffffc02053f0 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	8b660613          	addi	a2,a2,-1866 # ffffffffc0204d08 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	d1250513          	addi	a0,a0,-750 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	ede68693          	addi	a3,a3,-290 # ffffffffc0205348 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	89660613          	addi	a2,a2,-1898 # ffffffffc0204d08 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	cf250513          	addi	a0,a0,-782 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	01668693          	addi	a3,a3,22 # ffffffffc02054a0 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	87660613          	addi	a2,a2,-1930 # ffffffffc0204d08 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	cd250513          	addi	a0,a0,-814 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	e8668693          	addi	a3,a3,-378 # ffffffffc0205330 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	85660613          	addi	a2,a2,-1962 # ffffffffc0204d08 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	cb250513          	addi	a0,a0,-846 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	c7e60613          	addi	a2,a2,-898 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	c3a50513          	addi	a0,a0,-966 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	fee68693          	addi	a3,a3,-18 # ffffffffc02054d0 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	81e60613          	addi	a2,a2,-2018 # ffffffffc0204d08 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	c7a50513          	addi	a0,a0,-902 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	f8668693          	addi	a3,a3,-122 # ffffffffc0205488 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00002617          	auipc	a2,0x2
ffffffffc020250e:	7fe60613          	addi	a2,a2,2046 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	c5a50513          	addi	a0,a0,-934 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	f9668693          	addi	a3,a3,-106 # ffffffffc02054b8 <default_pmm_manager+0x400>
ffffffffc020252a:	00002617          	auipc	a2,0x2
ffffffffc020252e:	7de60613          	addi	a2,a2,2014 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	c3a50513          	addi	a0,a0,-966 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	f4668693          	addi	a3,a3,-186 # ffffffffc0205488 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00002617          	auipc	a2,0x2
ffffffffc020254e:	7be60613          	addi	a2,a2,1982 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	c1a50513          	addi	a0,a0,-998 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	07e68693          	addi	a3,a3,126 # ffffffffc02055e0 <default_pmm_manager+0x528>
ffffffffc020256a:	00002617          	auipc	a2,0x2
ffffffffc020256e:	79e60613          	addi	a2,a2,1950 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	bfa50513          	addi	a0,a0,-1030 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	02668693          	addi	a3,a3,38 # ffffffffc02055a8 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00002617          	auipc	a2,0x2
ffffffffc020258e:	77e60613          	addi	a2,a2,1918 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	bda50513          	addi	a0,a0,-1062 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	fee68693          	addi	a3,a3,-18 # ffffffffc0205590 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00002617          	auipc	a2,0x2
ffffffffc02025ae:	75e60613          	addi	a2,a2,1886 # ffffffffc0204d08 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	bba50513          	addi	a0,a0,-1094 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	f3668693          	addi	a3,a3,-202 # ffffffffc02054f8 <default_pmm_manager+0x440>
ffffffffc02025ca:	00002617          	auipc	a2,0x2
ffffffffc02025ce:	73e60613          	addi	a2,a2,1854 # ffffffffc0204d08 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	b9a50513          	addi	a0,a0,-1126 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	d4e68693          	addi	a3,a3,-690 # ffffffffc0205330 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	71e60613          	addi	a2,a2,1822 # ffffffffc0204d08 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	b4660613          	addi	a2,a2,-1210 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	b6250513          	addi	a0,a0,-1182 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	d2e68693          	addi	a3,a3,-722 # ffffffffc0205348 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	6e660613          	addi	a2,a2,1766 # ffffffffc0204d08 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	b4250513          	addi	a0,a0,-1214 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	d8668693          	addi	a3,a3,-634 # ffffffffc02053c0 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	6c660613          	addi	a2,a2,1734 # ffffffffc0204d08 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	b2250513          	addi	a0,a0,-1246 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	04668693          	addi	a3,a3,70 # ffffffffc02056a0 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	6a660613          	addi	a2,a2,1702 # ffffffffc0204d08 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	b0250513          	addi	a0,a0,-1278 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	fee68693          	addi	a3,a3,-18 # ffffffffc0205668 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	68660613          	addi	a2,a2,1670 # ffffffffc0204d08 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	ae250513          	addi	a0,a0,-1310 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	f9e68693          	addi	a3,a3,-98 # ffffffffc0205638 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	66660613          	addi	a2,a2,1638 # ffffffffc0204d08 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	ac250513          	addi	a0,a0,-1342 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	fc868693          	addi	a3,a3,-56 # ffffffffc02056e8 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	5e060613          	addi	a2,a2,1504 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	a3c50513          	addi	a0,a0,-1476 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	9b06b683          	ld	a3,-1616(a3) # ffffffffc0206150 <error_string+0x38>
...
ffffffffc02027dc:	f2868693          	addi	a3,a3,-216 # ffffffffc0205700 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	52860613          	addi	a2,a2,1320 # ffffffffc0204d08 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	98450513          	addi	a0,a0,-1660 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	94e60613          	addi	a2,a2,-1714 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	90a50513          	addi	a0,a0,-1782 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	f0e68693          	addi	a3,a3,-242 # ffffffffc0205720 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	4ee60613          	addi	a2,a2,1262 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	94a50513          	addi	a0,a0,-1718 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	94660613          	addi	a2,a2,-1722 # ffffffffc0205208 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	84250513          	addi	a0,a0,-1982 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	e5668693          	addi	a3,a3,-426 # ffffffffc0205730 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	42660613          	addi	a2,a2,1062 # ffffffffc0204d08 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	88250513          	addi	a0,a0,-1918 # ffffffffc0205170 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	e0668693          	addi	a3,a3,-506 # ffffffffc0205700 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	40660613          	addi	a2,a2,1030 # ffffffffc0204d08 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	86250513          	addi	a0,a0,-1950 # ffffffffc0205170 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	38e010ef          	jal	ra,ffffffffc0203cc4 <swapfs_init>
...
ffffffffc0202994:	de050513          	addi	a0,a0,-544 # ffffffffc0205770 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	da850513          	addi	a0,a0,-600 # ffffffffc0205788 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	277000ef          	jal	ra,ffffffffc0203462 <mm_create>
...
ffffffffc0202a20:	28b000ef          	jal	ra,ffffffffc02034aa <vma_create>
...
ffffffffc0202a2c:	2ed000ef          	jal	ra,ffffffffc0203518 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	dc850513          	addi	a0,a0,-568 # ffffffffc02057f8 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	dfc50513          	addi	a0,a0,-516 # ffffffffc0205848 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	e1050513          	addi	a0,a0,-496 # ffffffffc02058d0 <default_pmm_manager+0x818>
...
ffffffffc0202ba0:	5bcc0c13          	addi	s8,s8,1468 # ffffffffc0206158 <nbase>
...
ffffffffc0202c10:	d6c50513          	addi	a0,a0,-660 # ffffffffc0205978 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	1b3000ef          	jal	ra,ffffffffc02035e8 <mm_destroy>
...
ffffffffc0202c62:	d4a50513          	addi	a0,a0,-694 # ffffffffc02059a8 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	d5e50513          	addi	a0,a0,-674 # ffffffffc02059c8 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	07c68693          	addi	a3,a3,124 # ffffffffc0204cf8 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	08460613          	addi	a2,a2,132 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202c8c:	0ba00593          	li	a1,186
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	ad050513          	addi	a0,a0,-1328 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	cb468693          	addi	a3,a3,-844 # ffffffffc0205950 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	06460613          	addi	a2,a2,100 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202cac:	0fa00593          	li	a1,250
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	ab050513          	addi	a0,a0,-1360 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	46460613          	addi	a2,a2,1124 # ffffffffc0205120 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	44850513          	addi	a0,a0,1096 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	41c60613          	addi	a2,a2,1052 # ffffffffc02050f0 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	43050513          	addi	a0,a0,1072 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	b9c68693          	addi	a3,a3,-1124 # ffffffffc0205888 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	01460613          	addi	a2,a2,20 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202cfc:	0db00593          	li	a1,219
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	a6050513          	addi	a0,a0,-1440 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	b6468693          	addi	a3,a3,-1180 # ffffffffc0205870 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	ff460613          	addi	a2,a2,-12 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202d1c:	0da00593          	li	a1,218
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	a4050513          	addi	a0,a0,-1472 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	a1460613          	addi	a2,a2,-1516 # ffffffffc0205740 <default_pmm_manager+0x688>
ffffffffc0202d34:	02700593          	li	a1,39
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	a2850513          	addi	a0,a0,-1496 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	bf468693          	addi	a3,a3,-1036 # ffffffffc0205938 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	fbc60613          	addi	a2,a2,-68 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202d54:	0f900593          	li	a1,249
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	a0850513          	addi	a0,a0,-1528 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	bc468693          	addi	a3,a3,-1084 # ffffffffc0205928 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	f9c60613          	addi	a2,a2,-100 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202d74:	09d00593          	li	a1,157
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	9e850513          	addi	a0,a0,-1560 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	ba468693          	addi	a3,a3,-1116 # ffffffffc0205928 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	f7c60613          	addi	a2,a2,-132 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202d94:	09f00593          	li	a1,159
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	9c850513          	addi	a0,a0,-1592 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	13c68693          	addi	a3,a3,316 # ffffffffc0204ee0 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	f5c60613          	addi	a2,a2,-164 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202db4:	0f100593          	li	a1,241
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	9a850513          	addi	a0,a0,-1624 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	bdc68693          	addi	a3,a3,-1060 # ffffffffc02059a0 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	f3c60613          	addi	a2,a2,-196 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202dd4:	10000593          	li	a1,256
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	98850513          	addi	a0,a0,-1656 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	9f468693          	addi	a3,a3,-1548 # ffffffffc02057d8 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	f1c60613          	addi	a2,a2,-228 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202df4:	0ca00593          	li	a1,202
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	96850513          	addi	a0,a0,-1688 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	9e468693          	addi	a3,a3,-1564 # ffffffffc02057e8 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	efc60613          	addi	a2,a2,-260 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202e14:	0cd00593          	li	a1,205
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	94850513          	addi	a0,a0,-1720 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	a0c68693          	addi	a3,a3,-1524 # ffffffffc0205830 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	edc60613          	addi	a2,a2,-292 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202e34:	0d500593          	li	a1,213
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	92850513          	addi	a0,a0,-1752 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	ef468693          	addi	a3,a3,-268 # ffffffffc0204d38 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	ebc60613          	addi	a2,a2,-324 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202e54:	0bd00593          	li	a1,189
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	90850513          	addi	a0,a0,-1784 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	aa468693          	addi	a3,a3,-1372 # ffffffffc0205908 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	e9c60613          	addi	a2,a2,-356 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202e74:	09500593          	li	a1,149
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	8e850513          	addi	a0,a0,-1816 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	a8468693          	addi	a3,a3,-1404 # ffffffffc0205908 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	e7c60613          	addi	a2,a2,-388 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202e94:	09700593          	li	a1,151
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	8c850513          	addi	a0,a0,-1848 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	a7468693          	addi	a3,a3,-1420 # ffffffffc0205918 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	e5c60613          	addi	a2,a2,-420 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202eb4:	09900593          	li	a1,153
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	8a850513          	addi	a0,a0,-1880 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	a5468693          	addi	a3,a3,-1452 # ffffffffc0205918 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	e3c60613          	addi	a2,a2,-452 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202ed4:	09b00593          	li	a1,155
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	88850513          	addi	a0,a0,-1912 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	a1468693          	addi	a3,a3,-1516 # ffffffffc02058f8 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	e1c60613          	addi	a2,a2,-484 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202ef4:	09100593          	li	a1,145
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	86850513          	addi	a0,a0,-1944 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	9f468693          	addi	a3,a3,-1548 # ffffffffc02058f8 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	dfc60613          	addi	a2,a2,-516 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202f14:	09300593          	li	a1,147
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	84850513          	addi	a0,a0,-1976 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	88c68693          	addi	a3,a3,-1908 # ffffffffc02057b0 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	ddc60613          	addi	a2,a2,-548 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202f34:	0c200593          	li	a1,194
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	82850513          	addi	a0,a0,-2008 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	87c68693          	addi	a3,a3,-1924 # ffffffffc02057c0 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	dbc60613          	addi	a2,a2,-580 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202f54:	0c500593          	li	a1,197
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	80850513          	addi	a0,a0,-2040 # ffffffffc0205760 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	94468693          	addi	a3,a3,-1724 # ffffffffc02058a8 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	d9c60613          	addi	a2,a2,-612 # ffffffffc0204d08 <commands+0x738>
ffffffffc0202f74:	0e800593          	li	a1,232
ffffffffc0202f78:	00002517          	auipc	a0,0x2
ffffffffc0202f7c:	7e850513          	addi	a0,a0,2024 # ffffffffc0205760 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	a84b0b13          	addi	s6,s6,-1404 # ffffffffc0205a48 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	a64b8b93          	addi	s7,s7,-1436 # ffffffffc0205a30 <default_pmm_manager+0x978>
...
ffffffffc0203040:	557000ef          	jal	ra,ffffffffc0203d96 <swapfs_write>
...
ffffffffc0203082:	96a50513          	addi	a0,a0,-1686 # ffffffffc02059e8 <default_pmm_manager+0x930>
...
ffffffffc0203094:	98868693          	addi	a3,a3,-1656 # ffffffffc0205a18 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	c7060613          	addi	a2,a2,-912 # ffffffffc0204d08 <commands+0x738>
ffffffffc02030a0:	06600593          	li	a1,102
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	6bc50513          	addi	a0,a0,1724 # ffffffffc0205760 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	41f000ef          	jal	ra,ffffffffc0203cfc <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	9b050513          	addi	a0,a0,-1616 # ffffffffc0205a98 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	97e68693          	addi	a3,a3,-1666 # ffffffffc0205a88 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	bf660613          	addi	a2,a2,-1034 # ffffffffc0204d08 <commands+0x738>
ffffffffc020311a:	07c00593          	li	a1,124
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	64250513          	addi	a0,a0,1602 # ffffffffc0205760 <default_pmm_manager+0x6a8>
...
ffffffffc0203210:	71c68693          	addi	a3,a3,1820 # ffffffffc0205928 <default_pmm_manager+0x870>
ffffffffc0203214:	00002617          	auipc	a2,0x2
ffffffffc0203218:	af460613          	addi	a2,a2,-1292 # ffffffffc0204d08 <commands+0x738>
ffffffffc020321c:	07d00593          	li	a1,125
ffffffffc0203220:	00003517          	auipc	a0,0x3
ffffffffc0203224:	8b850513          	addi	a0,a0,-1864 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203228:	94cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc020322c:	00003697          	auipc	a3,0x3
ffffffffc0203230:	8fc68693          	addi	a3,a3,-1796 # ffffffffc0205b28 <default_pmm_manager+0xa70>
ffffffffc0203234:	00002617          	auipc	a2,0x2
ffffffffc0203238:	ad460613          	addi	a2,a2,-1324 # ffffffffc0204d08 <commands+0x738>
ffffffffc020323c:	09400593          	li	a1,148
ffffffffc0203240:	00003517          	auipc	a0,0x3
ffffffffc0203244:	89850513          	addi	a0,a0,-1896 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203248:	92cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020324c:	00003697          	auipc	a3,0x3
ffffffffc0203250:	8b468693          	addi	a3,a3,-1868 # ffffffffc0205b00 <default_pmm_manager+0xa48>
ffffffffc0203254:	00002617          	auipc	a2,0x2
ffffffffc0203258:	ab460613          	addi	a2,a2,-1356 # ffffffffc0204d08 <commands+0x738>
ffffffffc020325c:	09200593          	li	a1,146
ffffffffc0203260:	00003517          	auipc	a0,0x3
ffffffffc0203264:	87850513          	addi	a0,a0,-1928 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203268:	90cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020326c:	00003697          	auipc	a3,0x3
ffffffffc0203270:	88468693          	addi	a3,a3,-1916 # ffffffffc0205af0 <default_pmm_manager+0xa38>
ffffffffc0203274:	00002617          	auipc	a2,0x2
ffffffffc0203278:	a9460613          	addi	a2,a2,-1388 # ffffffffc0204d08 <commands+0x738>
ffffffffc020327c:	09100593          	li	a1,145
ffffffffc0203280:	00003517          	auipc	a0,0x3
ffffffffc0203284:	85850513          	addi	a0,a0,-1960 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203288:	8ecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020328c:	00003697          	auipc	a3,0x3
ffffffffc0203290:	86468693          	addi	a3,a3,-1948 # ffffffffc0205af0 <default_pmm_manager+0xa38>
ffffffffc0203294:	00002617          	auipc	a2,0x2
ffffffffc0203298:	a7460613          	addi	a2,a2,-1420 # ffffffffc0204d08 <commands+0x738>
ffffffffc020329c:	08f00593          	li	a1,143
ffffffffc02032a0:	00003517          	auipc	a0,0x3
ffffffffc02032a4:	83850513          	addi	a0,a0,-1992 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc02032a8:	8ccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ac:	00003697          	auipc	a3,0x3
ffffffffc02032b0:	84468693          	addi	a3,a3,-1980 # ffffffffc0205af0 <default_pmm_manager+0xa38>
ffffffffc02032b4:	00002617          	auipc	a2,0x2
ffffffffc02032b8:	a5460613          	addi	a2,a2,-1452 # ffffffffc0204d08 <commands+0x738>
ffffffffc02032bc:	08d00593          	li	a1,141
ffffffffc02032c0:	00003517          	auipc	a0,0x3
ffffffffc02032c4:	81850513          	addi	a0,a0,-2024 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc02032c8:	8acfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032cc:	00003697          	auipc	a3,0x3
ffffffffc02032d0:	82468693          	addi	a3,a3,-2012 # ffffffffc0205af0 <default_pmm_manager+0xa38>
ffffffffc02032d4:	00002617          	auipc	a2,0x2
ffffffffc02032d8:	a3460613          	addi	a2,a2,-1484 # ffffffffc0204d08 <commands+0x738>
ffffffffc02032dc:	08b00593          	li	a1,139
ffffffffc02032e0:	00002517          	auipc	a0,0x2
ffffffffc02032e4:	7f850513          	addi	a0,a0,2040 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc02032e8:	88cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ec:	00003697          	auipc	a3,0x3
ffffffffc02032f0:	80468693          	addi	a3,a3,-2044 # ffffffffc0205af0 <default_pmm_manager+0xa38>
ffffffffc02032f4:	00002617          	auipc	a2,0x2
ffffffffc02032f8:	a1460613          	addi	a2,a2,-1516 # ffffffffc0204d08 <commands+0x738>
ffffffffc02032fc:	08900593          	li	a1,137
ffffffffc0203300:	00002517          	auipc	a0,0x2
ffffffffc0203304:	7d850513          	addi	a0,a0,2008 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203308:	86cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020330c:	00002697          	auipc	a3,0x2
ffffffffc0203310:	7e468693          	addi	a3,a3,2020 # ffffffffc0205af0 <default_pmm_manager+0xa38>
ffffffffc0203314:	00002617          	auipc	a2,0x2
ffffffffc0203318:	9f460613          	addi	a2,a2,-1548 # ffffffffc0204d08 <commands+0x738>
ffffffffc020331c:	08700593          	li	a1,135
ffffffffc0203320:	00002517          	auipc	a0,0x2
ffffffffc0203324:	7b850513          	addi	a0,a0,1976 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203328:	84cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020332c:	00002697          	auipc	a3,0x2
ffffffffc0203330:	7c468693          	addi	a3,a3,1988 # ffffffffc0205af0 <default_pmm_manager+0xa38>
ffffffffc0203334:	00002617          	auipc	a2,0x2
ffffffffc0203338:	9d460613          	addi	a2,a2,-1580 # ffffffffc0204d08 <commands+0x738>
ffffffffc020333c:	08500593          	li	a1,133
ffffffffc0203340:	00002517          	auipc	a0,0x2
ffffffffc0203344:	79850513          	addi	a0,a0,1944 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203348:	82cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020334c:	00002697          	auipc	a3,0x2
ffffffffc0203350:	5dc68693          	addi	a3,a3,1500 # ffffffffc0205928 <default_pmm_manager+0x870>
ffffffffc0203354:	00002617          	auipc	a2,0x2
ffffffffc0203358:	9b460613          	addi	a2,a2,-1612 # ffffffffc0204d08 <commands+0x738>
ffffffffc020335c:	08300593          	li	a1,131
ffffffffc0203360:	00002517          	auipc	a0,0x2
ffffffffc0203364:	77850513          	addi	a0,a0,1912 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203368:	80cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020336c:	00002697          	auipc	a3,0x2
ffffffffc0203370:	5bc68693          	addi	a3,a3,1468 # ffffffffc0205928 <default_pmm_manager+0x870>
ffffffffc0203374:	00002617          	auipc	a2,0x2
ffffffffc0203378:	99460613          	addi	a2,a2,-1644 # ffffffffc0204d08 <commands+0x738>
ffffffffc020337c:	08100593          	li	a1,129
ffffffffc0203380:	00002517          	auipc	a0,0x2
ffffffffc0203384:	75850513          	addi	a0,a0,1880 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc0203388:	fedfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020338c:	00002697          	auipc	a3,0x2
ffffffffc0203390:	59c68693          	addi	a3,a3,1436 # ffffffffc0205928 <default_pmm_manager+0x870>
ffffffffc0203394:	00002617          	auipc	a2,0x2
ffffffffc0203398:	97460613          	addi	a2,a2,-1676 # ffffffffc0204d08 <commands+0x738>
ffffffffc020339c:	07f00593          	li	a1,127
ffffffffc02033a0:	00002517          	auipc	a0,0x2
ffffffffc02033a4:	73850513          	addi	a0,a0,1848 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
...
ffffffffc02033b0:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc02033b2:	c39d                	beqz	a5,ffffffffc02033d8 <_clock_swap_out_victim+0x2c>
     assert(in_tick==0);
ffffffffc02033b4:	e211                	bnez	a2,ffffffffc02033b8 <_clock_swap_out_victim+0xc>
    while (1) {
ffffffffc02033b6:	a001                	j	ffffffffc02033b6 <_clock_swap_out_victim+0xa>
     assert(in_tick==0);
ffffffffc02033b8:	00002697          	auipc	a3,0x2
ffffffffc02033bc:	79068693          	addi	a3,a3,1936 # ffffffffc0205b48 <default_pmm_manager+0xa90>
ffffffffc02033c0:	00002617          	auipc	a2,0x2
ffffffffc02033c4:	94860613          	addi	a2,a2,-1720 # ffffffffc0204d08 <commands+0x738>
ffffffffc02033c8:	04a00593          	li	a1,74
ffffffffc02033cc:	00002517          	auipc	a0,0x2
ffffffffc02033d0:	70c50513          	addi	a0,a0,1804 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc02033d4:	fa1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(head != NULL);
ffffffffc02033d8:	00002697          	auipc	a3,0x2
ffffffffc02033dc:	76068693          	addi	a3,a3,1888 # ffffffffc0205b38 <default_pmm_manager+0xa80>
ffffffffc02033e0:	00002617          	auipc	a2,0x2
ffffffffc02033e4:	92860613          	addi	a2,a2,-1752 # ffffffffc0204d08 <commands+0x738>
ffffffffc02033e8:	04900593          	li	a1,73
ffffffffc02033ec:	00002517          	auipc	a0,0x2
ffffffffc02033f0:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
ffffffffc02033f4:	f81fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033f8 <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033f8:	0000e797          	auipc	a5,0xe
ffffffffc02033fc:	1607b783          	ld	a5,352(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc0203400:	cf89                	beqz	a5,ffffffffc020341a <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203402:	751c                	ld	a5,40(a0)
ffffffffc0203404:	03060713          	addi	a4,a2,48
}
ffffffffc0203408:	4501                	li	a0,0
    __list_add(elm, listelm, listelm->next);
ffffffffc020340a:	6794                	ld	a3,8(a5)
    prev->next = next->prev = elm;
ffffffffc020340c:	e298                	sd	a4,0(a3)
ffffffffc020340e:	e798                	sd	a4,8(a5)
    elm->prev = prev;
ffffffffc0203410:	fa1c                	sd	a5,48(a2)
    page->visited = 1;
ffffffffc0203412:	4785                	li	a5,1
    elm->next = next;
ffffffffc0203414:	fe14                	sd	a3,56(a2)
ffffffffc0203416:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc0203420:	73c68693          	addi	a3,a3,1852 # ffffffffc0205b58 <default_pmm_manager+0xaa0>
ffffffffc0203424:	00002617          	auipc	a2,0x2
ffffffffc0203428:	8e460613          	addi	a2,a2,-1820 # ffffffffc0204d08 <commands+0x738>
ffffffffc020342c:	03600593          	li	a1,54
ffffffffc0203430:	00002517          	auipc	a0,0x2
ffffffffc0203434:	6a850513          	addi	a0,a0,1704 # ffffffffc0205ad8 <default_pmm_manager+0xa20>
{
ffffffffc0203438:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020343a:	f3bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020343e <check_vma_overlap.part.0>:
}
...
ffffffffc0203444:	75868693          	addi	a3,a3,1880 # ffffffffc0205b98 <default_pmm_manager+0xae0>
ffffffffc0203448:	00002617          	auipc	a2,0x2
ffffffffc020344c:	8c060613          	addi	a2,a2,-1856 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203450:	07d00593          	li	a1,125
ffffffffc0203454:	00002517          	auipc	a0,0x2
ffffffffc0203458:	76450513          	addi	a0,a0,1892 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc020345c:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020345e:	f17fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203462 <mm_create>:
mm_create(void) {
ffffffffc0203462:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203464:	03000513          	li	a0,48
mm_create(void) {
ffffffffc0203468:	e022                	sd	s0,0(sp)
ffffffffc020346a:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020346c:	b0cff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203470:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203472:	c105                	beqz	a0,ffffffffc0203492 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc0203474:	e408                	sd	a0,8(s0)
ffffffffc0203476:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc0203478:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020347c:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203480:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203484:	0000e797          	auipc	a5,0xe
ffffffffc0203488:	0cc7a783          	lw	a5,204(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc020348c:	eb81                	bnez	a5,ffffffffc020349c <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc020348e:	02053423          	sd	zero,40(a0)
}
ffffffffc0203492:	60a2                	ld	ra,8(sp)
...
ffffffffc020349a:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020349c:	ae9ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc02034a0:	60a2                	ld	ra,8(sp)
ffffffffc02034a2:	8522                	mv	a0,s0
...
ffffffffc02034bc:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02034be:	abaff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
...
ffffffffc02034d8:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc02034da:	c505                	beqz	a0,ffffffffc0203502 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc02034dc:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02034de:	c501                	beqz	a0,ffffffffc02034e6 <find_vma+0xe>
ffffffffc02034e0:	651c                	ld	a5,8(a0)
ffffffffc02034e2:	02f5f263          	bgeu	a1,a5,ffffffffc0203506 <find_vma+0x2e>
    return listelm->next;
ffffffffc02034e6:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc02034e8:	00f68d63          	beq	a3,a5,ffffffffc0203502 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc02034ec:	fe87b703          	ld	a4,-24(a5)
ffffffffc02034f0:	00e5e663          	bltu	a1,a4,ffffffffc02034fc <find_vma+0x24>
ffffffffc02034f4:	ff07b703          	ld	a4,-16(a5)
ffffffffc02034f8:	00e5ec63          	bltu	a1,a4,ffffffffc0203510 <find_vma+0x38>
ffffffffc02034fc:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc02034fe:	fef697e3          	bne	a3,a5,ffffffffc02034ec <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203502:	4501                	li	a0,0
}
ffffffffc0203504:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203506:	691c                	ld	a5,16(a0)
ffffffffc0203508:	fcf5ffe3          	bgeu	a1,a5,ffffffffc02034e6 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc020350c:	ea88                	sd	a0,16(a3)
ffffffffc020350e:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203510:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203514:	ea88                	sd	a0,16(a3)
ffffffffc0203516:	8082                	ret

ffffffffc0203518 <insert_vma_struct>:
...
ffffffffc0203518:	6590                	ld	a2,8(a1)
ffffffffc020351a:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc020351e:	1141                	addi	sp,sp,-16
ffffffffc0203520:	e406                	sd	ra,8(sp)
ffffffffc0203522:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203524:	01066763          	bltu	a2,a6,ffffffffc0203532 <insert_vma_struct+0x1a>
ffffffffc0203528:	a085                	j	ffffffffc0203588 <insert_vma_struct+0x70>
...
ffffffffc020352a:	fe87b703          	ld	a4,-24(a5)
ffffffffc020352e:	04e66863          	bltu	a2,a4,ffffffffc020357e <insert_vma_struct+0x66>
ffffffffc0203532:	86be                	mv	a3,a5
ffffffffc0203534:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0203536:	fef51ae3          	bne	a0,a5,ffffffffc020352a <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc020353a:	02a68463          	beq	a3,a0,ffffffffc0203562 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc020353e:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203542:	fe86b883          	ld	a7,-24(a3)
ffffffffc0203546:	08e8f163          	bgeu	a7,a4,ffffffffc02035c8 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020354a:	04e66f63          	bltu	a2,a4,ffffffffc02035a8 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc020354e:	00f50a63          	beq	a0,a5,ffffffffc0203562 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203552:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203556:	05076963          	bltu	a4,a6,ffffffffc02035a8 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc020355a:	ff07b603          	ld	a2,-16(a5)
ffffffffc020355e:	02c77363          	bgeu	a4,a2,ffffffffc0203584 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203562:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc0203564:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc0203566:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc020356a:	e390                	sd	a2,0(a5)
ffffffffc020356c:	e690                	sd	a2,8(a3)
}
ffffffffc020356e:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc0203570:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203572:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc0203574:	0017079b          	addiw	a5,a4,1
ffffffffc0203578:	d11c                	sw	a5,32(a0)
}
ffffffffc020357a:	0141                	addi	sp,sp,16
ffffffffc020357c:	8082                	ret
    if (le_prev != list) {
ffffffffc020357e:	fca690e3          	bne	a3,a0,ffffffffc020353e <insert_vma_struct+0x26>
ffffffffc0203582:	bfd1                	j	ffffffffc0203556 <insert_vma_struct+0x3e>
ffffffffc0203584:	ebbff0ef          	jal	ra,ffffffffc020343e <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203588:	00002697          	auipc	a3,0x2
ffffffffc020358c:	64068693          	addi	a3,a3,1600 # ffffffffc0205bc8 <default_pmm_manager+0xb10>
ffffffffc0203590:	00001617          	auipc	a2,0x1
ffffffffc0203594:	77860613          	addi	a2,a2,1912 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203598:	08400593          	li	a1,132
ffffffffc020359c:	00002517          	auipc	a0,0x2
ffffffffc02035a0:	61c50513          	addi	a0,a0,1564 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02035a4:	dd1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035a8:	00002697          	auipc	a3,0x2
ffffffffc02035ac:	66068693          	addi	a3,a3,1632 # ffffffffc0205c08 <default_pmm_manager+0xb50>
ffffffffc02035b0:	00001617          	auipc	a2,0x1
ffffffffc02035b4:	75860613          	addi	a2,a2,1880 # ffffffffc0204d08 <commands+0x738>
ffffffffc02035b8:	07c00593          	li	a1,124
ffffffffc02035bc:	00002517          	auipc	a0,0x2
ffffffffc02035c0:	5fc50513          	addi	a0,a0,1532 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02035c4:	db1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035c8:	00002697          	auipc	a3,0x2
ffffffffc02035cc:	62068693          	addi	a3,a3,1568 # ffffffffc0205be8 <default_pmm_manager+0xb30>
ffffffffc02035d0:	00001617          	auipc	a2,0x1
ffffffffc02035d4:	73860613          	addi	a2,a2,1848 # ffffffffc0204d08 <commands+0x738>
ffffffffc02035d8:	07b00593          	li	a1,123
ffffffffc02035dc:	00002517          	auipc	a0,0x2
ffffffffc02035e0:	5dc50513          	addi	a0,a0,1500 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02035e4:	d91fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02035e8 <mm_destroy>:
...
ffffffffc02035ec:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc02035ee:	6508                	ld	a0,8(a0)
ffffffffc02035f0:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc02035f2:	00a40e63          	beq	s0,a0,ffffffffc020360e <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc02035f6:	6118                	ld	a4,0(a0)
ffffffffc02035f8:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02035fa:	03000593          	li	a1,48
ffffffffc02035fe:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203600:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203602:	e398                	sd	a4,0(a5)
ffffffffc0203604:	a2eff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203608:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020360a:	fea416e3          	bne	s0,a0,ffffffffc02035f6 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020360e:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203610:	6402                	ld	s0,0(sp)
ffffffffc0203612:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203614:	03000593          	li	a1,48
}
ffffffffc0203618:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020361a:	a18ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc020361e <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc020361e:	715d                	addi	sp,sp,-80
ffffffffc0203620:	e486                	sd	ra,72(sp)
...
ffffffffc020362c:	ec56                	sd	s5,24(sp)
ffffffffc020362e:	e85a                	sd	s6,16(sp)
ffffffffc0203630:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203632:	860fe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203638:	85afe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020363c:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020363e:	03000513          	li	a0,48
ffffffffc0203642:	936ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc0203646:	56050863          	beqz	a0,ffffffffc0203bb6 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc020364a:	e508                	sd	a0,8(a0)
ffffffffc020364c:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc020364e:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203652:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203656:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020365a:	0000e797          	auipc	a5,0xe
ffffffffc020365e:	ef67a783          	lw	a5,-266(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203662:	84aa                	mv	s1,a0
ffffffffc0203664:	e7b9                	bnez	a5,ffffffffc02036b2 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc0203666:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc020366a:	03200413          	li	s0,50
ffffffffc020366e:	a811                	j	ffffffffc0203682 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc0203670:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203672:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203674:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc0203678:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020367a:	8526                	mv	a0,s1
ffffffffc020367c:	e9dff0ef          	jal	ra,ffffffffc0203518 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203680:	cc05                	beqz	s0,ffffffffc02036b8 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203682:	03000513          	li	a0,48
ffffffffc0203686:	8f2ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020368a:	85aa                	mv	a1,a0
ffffffffc020368c:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203690:	f165                	bnez	a0,ffffffffc0203670 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc0203692:	00002697          	auipc	a3,0x2
ffffffffc0203696:	15668693          	addi	a3,a3,342 # ffffffffc02057e8 <default_pmm_manager+0x730>
ffffffffc020369a:	00001617          	auipc	a2,0x1
ffffffffc020369e:	66e60613          	addi	a2,a2,1646 # ffffffffc0204d08 <commands+0x738>
ffffffffc02036a2:	0ce00593          	li	a1,206
ffffffffc02036a6:	00002517          	auipc	a0,0x2
ffffffffc02036aa:	51250513          	addi	a0,a0,1298 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02036ae:	cc7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02036b2:	8d3ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02036b6:	bf55                	j	ffffffffc020366a <vmm_init+0x4c>
ffffffffc02036b8:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02036bc:	1f900913          	li	s2,505
ffffffffc02036c0:	a819                	j	ffffffffc02036d6 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc02036c2:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036c4:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036c6:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02036ca:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036cc:	8526                	mv	a0,s1
ffffffffc02036ce:	e4bff0ef          	jal	ra,ffffffffc0203518 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02036d2:	03240a63          	beq	s0,s2,ffffffffc0203706 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036d6:	03000513          	li	a0,48
ffffffffc02036da:	89eff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036de:	85aa                	mv	a1,a0
ffffffffc02036e0:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036e4:	fd79                	bnez	a0,ffffffffc02036c2 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc02036e6:	00002697          	auipc	a3,0x2
ffffffffc02036ea:	10268693          	addi	a3,a3,258 # ffffffffc02057e8 <default_pmm_manager+0x730>
ffffffffc02036ee:	00001617          	auipc	a2,0x1
ffffffffc02036f2:	61a60613          	addi	a2,a2,1562 # ffffffffc0204d08 <commands+0x738>
ffffffffc02036f6:	0d400593          	li	a1,212
ffffffffc02036fa:	00002517          	auipc	a0,0x2
ffffffffc02036fe:	4be50513          	addi	a0,a0,1214 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203702:	c73fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203706:	649c                	ld	a5,8(s1)
ffffffffc0203708:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020370a:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc020370e:	2ef48463          	beq	s1,a5,ffffffffc02039f6 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203712:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203716:	ffe70693          	addi	a3,a4,-2
ffffffffc020371a:	26d61e63          	bne	a2,a3,ffffffffc0203996 <vmm_init+0x378>
ffffffffc020371e:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203722:	26e69a63          	bne	a3,a4,ffffffffc0203996 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203726:	0715                	addi	a4,a4,5
ffffffffc0203728:	679c                	ld	a5,8(a5)
ffffffffc020372a:	feb712e3          	bne	a4,a1,ffffffffc020370e <vmm_init+0xf0>
ffffffffc020372e:	4b1d                	li	s6,7
ffffffffc0203730:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203732:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203736:	85a2                	mv	a1,s0
ffffffffc0203738:	8526                	mv	a0,s1
ffffffffc020373a:	d9fff0ef          	jal	ra,ffffffffc02034d8 <find_vma>
ffffffffc020373e:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203740:	2c050b63          	beqz	a0,ffffffffc0203a16 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203744:	00140593          	addi	a1,s0,1
ffffffffc0203748:	8526                	mv	a0,s1
ffffffffc020374a:	d8fff0ef          	jal	ra,ffffffffc02034d8 <find_vma>
ffffffffc020374e:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203750:	2e050363          	beqz	a0,ffffffffc0203a36 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203754:	85da                	mv	a1,s6
ffffffffc0203756:	8526                	mv	a0,s1
ffffffffc0203758:	d81ff0ef          	jal	ra,ffffffffc02034d8 <find_vma>
        assert(vma3 == NULL);
ffffffffc020375c:	2e051d63          	bnez	a0,ffffffffc0203a56 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203760:	00340593          	addi	a1,s0,3
ffffffffc0203764:	8526                	mv	a0,s1
ffffffffc0203766:	d73ff0ef          	jal	ra,ffffffffc02034d8 <find_vma>
        assert(vma4 == NULL);
ffffffffc020376a:	30051663          	bnez	a0,ffffffffc0203a76 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc020376e:	00440593          	addi	a1,s0,4
ffffffffc0203772:	8526                	mv	a0,s1
ffffffffc0203774:	d65ff0ef          	jal	ra,ffffffffc02034d8 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203778:	30051f63          	bnez	a0,ffffffffc0203a96 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc020377c:	00893783          	ld	a5,8(s2)
ffffffffc0203780:	24879b63          	bne	a5,s0,ffffffffc02039d6 <vmm_init+0x3b8>
ffffffffc0203784:	01093783          	ld	a5,16(s2)
ffffffffc0203788:	25679763          	bne	a5,s6,ffffffffc02039d6 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc020378c:	008ab783          	ld	a5,8(s5)
ffffffffc0203790:	22879363          	bne	a5,s0,ffffffffc02039b6 <vmm_init+0x398>
ffffffffc0203794:	010ab783          	ld	a5,16(s5)
ffffffffc0203798:	21679f63          	bne	a5,s6,ffffffffc02039b6 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020379c:	0415                	addi	s0,s0,5
ffffffffc020379e:	0b15                	addi	s6,s6,5
ffffffffc02037a0:	f9741be3          	bne	s0,s7,ffffffffc0203736 <vmm_init+0x118>
ffffffffc02037a4:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc02037a6:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc02037a8:	85a2                	mv	a1,s0
ffffffffc02037aa:	8526                	mv	a0,s1
ffffffffc02037ac:	d2dff0ef          	jal	ra,ffffffffc02034d8 <find_vma>
ffffffffc02037b0:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc02037b4:	c90d                	beqz	a0,ffffffffc02037e6 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc02037b6:	6914                	ld	a3,16(a0)
ffffffffc02037b8:	6510                	ld	a2,8(a0)
ffffffffc02037ba:	00002517          	auipc	a0,0x2
ffffffffc02037be:	56e50513          	addi	a0,a0,1390 # ffffffffc0205d28 <default_pmm_manager+0xc70>
ffffffffc02037c2:	8f9fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02037c6:	00002697          	auipc	a3,0x2
ffffffffc02037ca:	58a68693          	addi	a3,a3,1418 # ffffffffc0205d50 <default_pmm_manager+0xc98>
ffffffffc02037ce:	00001617          	auipc	a2,0x1
ffffffffc02037d2:	53a60613          	addi	a2,a2,1338 # ffffffffc0204d08 <commands+0x738>
ffffffffc02037d6:	0f600593          	li	a1,246
ffffffffc02037da:	00002517          	auipc	a0,0x2
ffffffffc02037de:	3de50513          	addi	a0,a0,990 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02037e2:	b93fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc02037e6:	147d                	addi	s0,s0,-1
ffffffffc02037e8:	fd2410e3          	bne	s0,s2,ffffffffc02037a8 <vmm_init+0x18a>
ffffffffc02037ec:	a811                	j	ffffffffc0203800 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc02037ee:	6118                	ld	a4,0(a0)
ffffffffc02037f0:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02037f2:	03000593          	li	a1,48
ffffffffc02037f6:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02037f8:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02037fa:	e398                	sd	a4,0(a5)
ffffffffc02037fc:	836ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203800:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203802:	fea496e3          	bne	s1,a0,ffffffffc02037ee <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203806:	03000593          	li	a1,48
ffffffffc020380a:	8526                	mv	a0,s1
ffffffffc020380c:	826ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203810:	e83fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203814:	3caa1163          	bne	s4,a0,ffffffffc0203bd6 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203818:	00002517          	auipc	a0,0x2
ffffffffc020381c:	57850513          	addi	a0,a0,1400 # ffffffffc0205d90 <default_pmm_manager+0xcd8>
ffffffffc0203820:	89bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203824:	e6ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203828:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020382a:	03000513          	li	a0,48
ffffffffc020382e:	f4bfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203832:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203834:	2a050163          	beqz	a0,ffffffffc0203ad6 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203838:	0000e797          	auipc	a5,0xe
ffffffffc020383c:	d187a783          	lw	a5,-744(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203840:	e508                	sd	a0,8(a0)
ffffffffc0203842:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203844:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203848:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020384c:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203850:	14079063          	bnez	a5,ffffffffc0203990 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203854:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203858:	0000e917          	auipc	s2,0xe
ffffffffc020385c:	cc093903          	ld	s2,-832(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203860:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203864:	0000e717          	auipc	a4,0xe
ffffffffc0203868:	ce873e23          	sd	s0,-772(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020386c:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203870:	24079363          	bnez	a5,ffffffffc0203ab6 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203874:	03000513          	li	a0,48
ffffffffc0203878:	f01fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020387c:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc020387e:	28050063          	beqz	a0,ffffffffc0203afe <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc0203882:	002007b7          	lui	a5,0x200
ffffffffc0203886:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc020388a:	4789                	li	a5,2
...
ffffffffc020388c:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc020388e:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203892:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203894:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203898:	c81ff0ef          	jal	ra,ffffffffc0203518 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc020389c:	10000593          	li	a1,256
ffffffffc02038a0:	8522                	mv	a0,s0
ffffffffc02038a2:	c37ff0ef          	jal	ra,ffffffffc02034d8 <find_vma>
ffffffffc02038a6:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02038aa:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02038ae:	26aa1863          	bne	s4,a0,ffffffffc0203b1e <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc02038b2:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc02038b6:	0785                	addi	a5,a5,1
ffffffffc02038b8:	fee79de3          	bne	a5,a4,ffffffffc02038b2 <vmm_init+0x294>
        sum += i;
ffffffffc02038bc:	6705                	lui	a4,0x1
ffffffffc02038be:	10000793          	li	a5,256
ffffffffc02038c2:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02038c6:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02038ca:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc02038ce:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc02038d0:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02038d2:	fec79ce3          	bne	a5,a2,ffffffffc02038ca <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc02038d6:	26071463          	bnez	a4,ffffffffc0203b3e <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02038da:	4581                	li	a1,0
ffffffffc02038dc:	854a                	mv	a0,s2
ffffffffc02038de:	83efe0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02038e2:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc02038e6:	0000e717          	auipc	a4,0xe
ffffffffc02038ea:	c3a73703          	ld	a4,-966(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc02038ee:	078a                	slli	a5,a5,0x2
ffffffffc02038f0:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc02038f2:	26e7f663          	bgeu	a5,a4,ffffffffc0203b5e <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc02038f6:	00003717          	auipc	a4,0x3
ffffffffc02038fa:	86273703          	ld	a4,-1950(a4) # ffffffffc0206158 <nbase>
ffffffffc02038fe:	8f99                	sub	a5,a5,a4
ffffffffc0203900:	00379713          	slli	a4,a5,0x3
ffffffffc0203904:	97ba                	add	a5,a5,a4
ffffffffc0203906:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203908:	0000e517          	auipc	a0,0xe
ffffffffc020390c:	c2053503          	ld	a0,-992(a0) # ffffffffc0211528 <pages>
ffffffffc0203910:	953e                	add	a0,a0,a5
ffffffffc0203912:	4585                	li	a1,1
ffffffffc0203914:	d3ffd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203918:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc020391a:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc020391e:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203922:	00a40e63          	beq	s0,a0,ffffffffc020393e <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203926:	6118                	ld	a4,0(a0)
ffffffffc0203928:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020392a:	03000593          	li	a1,48
ffffffffc020392e:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203930:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203932:	e398                	sd	a4,0(a5)
ffffffffc0203934:	efffe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203938:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020393a:	fea416e3          	bne	s0,a0,ffffffffc0203926 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020393e:	03000593          	li	a1,48
...
ffffffffc0203948:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc020394a:	0000e797          	auipc	a5,0xe
ffffffffc020394e:	c007bb23          	sd	zero,-1002(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203952:	d41fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203956:	22a49063          	bne	s1,a0,ffffffffc0203b76 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc020395a:	00002517          	auipc	a0,0x2
ffffffffc020395e:	48650513          	addi	a0,a0,1158 # ffffffffc0205de0 <default_pmm_manager+0xd28>
ffffffffc0203962:	f58fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203966:	d2dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc020396a:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020396c:	22a99563          	bne	s3,a0,ffffffffc0203b96 <vmm_init+0x578>
}
ffffffffc0203970:	6406                	ld	s0,64(sp)
ffffffffc0203972:	60a6                	ld	ra,72(sp)
ffffffffc0203974:	74e2                	ld	s1,56(sp)
ffffffffc0203976:	7942                	ld	s2,48(sp)
ffffffffc0203978:	79a2                	ld	s3,40(sp)
ffffffffc020397a:	7a02                	ld	s4,32(sp)
ffffffffc020397c:	6ae2                	ld	s5,24(sp)
ffffffffc020397e:	6b42                	ld	s6,16(sp)
ffffffffc0203980:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203982:	00002517          	auipc	a0,0x2
ffffffffc0203986:	47e50513          	addi	a0,a0,1150 # ffffffffc0205e00 <default_pmm_manager+0xd48>
}
ffffffffc020398a:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc020398c:	f2efc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203990:	df4ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203994:	b5d1                	j	ffffffffc0203858 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203996:	00002697          	auipc	a3,0x2
ffffffffc020399a:	2aa68693          	addi	a3,a3,682 # ffffffffc0205c40 <default_pmm_manager+0xb88>
ffffffffc020399e:	00001617          	auipc	a2,0x1
ffffffffc02039a2:	36a60613          	addi	a2,a2,874 # ffffffffc0204d08 <commands+0x738>
ffffffffc02039a6:	0dd00593          	li	a1,221
ffffffffc02039aa:	00002517          	auipc	a0,0x2
ffffffffc02039ae:	20e50513          	addi	a0,a0,526 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02039b2:	9c3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02039b6:	00002697          	auipc	a3,0x2
ffffffffc02039ba:	34268693          	addi	a3,a3,834 # ffffffffc0205cf8 <default_pmm_manager+0xc40>
ffffffffc02039be:	00001617          	auipc	a2,0x1
ffffffffc02039c2:	34a60613          	addi	a2,a2,842 # ffffffffc0204d08 <commands+0x738>
ffffffffc02039c6:	0ee00593          	li	a1,238
ffffffffc02039ca:	00002517          	auipc	a0,0x2
ffffffffc02039ce:	1ee50513          	addi	a0,a0,494 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02039d2:	9a3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02039d6:	00002697          	auipc	a3,0x2
ffffffffc02039da:	2f268693          	addi	a3,a3,754 # ffffffffc0205cc8 <default_pmm_manager+0xc10>
ffffffffc02039de:	00001617          	auipc	a2,0x1
ffffffffc02039e2:	32a60613          	addi	a2,a2,810 # ffffffffc0204d08 <commands+0x738>
ffffffffc02039e6:	0ed00593          	li	a1,237
ffffffffc02039ea:	00002517          	auipc	a0,0x2
ffffffffc02039ee:	1ce50513          	addi	a0,a0,462 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc02039f2:	983fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc02039f6:	00002697          	auipc	a3,0x2
ffffffffc02039fa:	23268693          	addi	a3,a3,562 # ffffffffc0205c28 <default_pmm_manager+0xb70>
ffffffffc02039fe:	00001617          	auipc	a2,0x1
ffffffffc0203a02:	30a60613          	addi	a2,a2,778 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203a06:	0db00593          	li	a1,219
ffffffffc0203a0a:	00002517          	auipc	a0,0x2
ffffffffc0203a0e:	1ae50513          	addi	a0,a0,430 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203a12:	963fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a16:	00002697          	auipc	a3,0x2
ffffffffc0203a1a:	26268693          	addi	a3,a3,610 # ffffffffc0205c78 <default_pmm_manager+0xbc0>
ffffffffc0203a1e:	00001617          	auipc	a2,0x1
ffffffffc0203a22:	2ea60613          	addi	a2,a2,746 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203a26:	0e300593          	li	a1,227
ffffffffc0203a2a:	00002517          	auipc	a0,0x2
ffffffffc0203a2e:	18e50513          	addi	a0,a0,398 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203a32:	943fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a36:	00002697          	auipc	a3,0x2
ffffffffc0203a3a:	25268693          	addi	a3,a3,594 # ffffffffc0205c88 <default_pmm_manager+0xbd0>
ffffffffc0203a3e:	00001617          	auipc	a2,0x1
ffffffffc0203a42:	2ca60613          	addi	a2,a2,714 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203a46:	0e500593          	li	a1,229
ffffffffc0203a4a:	00002517          	auipc	a0,0x2
ffffffffc0203a4e:	16e50513          	addi	a0,a0,366 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203a52:	923fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203a56:	00002697          	auipc	a3,0x2
ffffffffc0203a5a:	24268693          	addi	a3,a3,578 # ffffffffc0205c98 <default_pmm_manager+0xbe0>
ffffffffc0203a5e:	00001617          	auipc	a2,0x1
ffffffffc0203a62:	2aa60613          	addi	a2,a2,682 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203a66:	0e700593          	li	a1,231
ffffffffc0203a6a:	00002517          	auipc	a0,0x2
ffffffffc0203a6e:	14e50513          	addi	a0,a0,334 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203a72:	903fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203a76:	00002697          	auipc	a3,0x2
ffffffffc0203a7a:	23268693          	addi	a3,a3,562 # ffffffffc0205ca8 <default_pmm_manager+0xbf0>
ffffffffc0203a7e:	00001617          	auipc	a2,0x1
ffffffffc0203a82:	28a60613          	addi	a2,a2,650 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203a86:	0e900593          	li	a1,233
ffffffffc0203a8a:	00002517          	auipc	a0,0x2
ffffffffc0203a8e:	12e50513          	addi	a0,a0,302 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203a92:	8e3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203a96:	00002697          	auipc	a3,0x2
ffffffffc0203a9a:	22268693          	addi	a3,a3,546 # ffffffffc0205cb8 <default_pmm_manager+0xc00>
ffffffffc0203a9e:	00001617          	auipc	a2,0x1
ffffffffc0203aa2:	26a60613          	addi	a2,a2,618 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203aa6:	0eb00593          	li	a1,235
ffffffffc0203aaa:	00002517          	auipc	a0,0x2
ffffffffc0203aae:	10e50513          	addi	a0,a0,270 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203ab2:	8c3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203ab6:	00002697          	auipc	a3,0x2
ffffffffc0203aba:	d2268693          	addi	a3,a3,-734 # ffffffffc02057d8 <default_pmm_manager+0x720>
ffffffffc0203abe:	00001617          	auipc	a2,0x1
ffffffffc0203ac2:	24a60613          	addi	a2,a2,586 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203ac6:	10d00593          	li	a1,269
ffffffffc0203aca:	00002517          	auipc	a0,0x2
ffffffffc0203ace:	0ee50513          	addi	a0,a0,238 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203ad2:	8a3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ad6:	00002697          	auipc	a3,0x2
ffffffffc0203ada:	34268693          	addi	a3,a3,834 # ffffffffc0205e18 <default_pmm_manager+0xd60>
ffffffffc0203ade:	00001617          	auipc	a2,0x1
ffffffffc0203ae2:	22a60613          	addi	a2,a2,554 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203ae6:	10a00593          	li	a1,266
ffffffffc0203aea:	00002517          	auipc	a0,0x2
ffffffffc0203aee:	0ce50513          	addi	a0,a0,206 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
    check_mm_struct = mm_create();
ffffffffc0203af2:	0000e797          	auipc	a5,0xe
ffffffffc0203af6:	a607b723          	sd	zero,-1426(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203afa:	87bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203afe:	00002697          	auipc	a3,0x2
ffffffffc0203b02:	cea68693          	addi	a3,a3,-790 # ffffffffc02057e8 <default_pmm_manager+0x730>
ffffffffc0203b06:	00001617          	auipc	a2,0x1
ffffffffc0203b0a:	20260613          	addi	a2,a2,514 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203b0e:	11100593          	li	a1,273
ffffffffc0203b12:	00002517          	auipc	a0,0x2
ffffffffc0203b16:	0a650513          	addi	a0,a0,166 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203b1a:	85bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b1e:	00002697          	auipc	a3,0x2
ffffffffc0203b22:	29268693          	addi	a3,a3,658 # ffffffffc0205db0 <default_pmm_manager+0xcf8>
ffffffffc0203b26:	00001617          	auipc	a2,0x1
ffffffffc0203b2a:	1e260613          	addi	a2,a2,482 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203b2e:	11600593          	li	a1,278
ffffffffc0203b32:	00002517          	auipc	a0,0x2
ffffffffc0203b36:	08650513          	addi	a0,a0,134 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203b3a:	83bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203b3e:	00002697          	auipc	a3,0x2
ffffffffc0203b42:	29268693          	addi	a3,a3,658 # ffffffffc0205dd0 <default_pmm_manager+0xd18>
ffffffffc0203b46:	00001617          	auipc	a2,0x1
ffffffffc0203b4a:	1c260613          	addi	a2,a2,450 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203b4e:	12000593          	li	a1,288
ffffffffc0203b52:	00002517          	auipc	a0,0x2
ffffffffc0203b56:	06650513          	addi	a0,a0,102 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203b5a:	81bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203b5e:	00001617          	auipc	a2,0x1
ffffffffc0203b62:	59260613          	addi	a2,a2,1426 # ffffffffc02050f0 <default_pmm_manager+0x38>
ffffffffc0203b66:	06500593          	li	a1,101
ffffffffc0203b6a:	00001517          	auipc	a0,0x1
ffffffffc0203b6e:	5a650513          	addi	a0,a0,1446 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc0203b72:	803fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203b76:	00002697          	auipc	a3,0x2
ffffffffc0203b7a:	1f268693          	addi	a3,a3,498 # ffffffffc0205d68 <default_pmm_manager+0xcb0>
ffffffffc0203b7e:	00001617          	auipc	a2,0x1
ffffffffc0203b82:	18a60613          	addi	a2,a2,394 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203b86:	12e00593          	li	a1,302
ffffffffc0203b8a:	00002517          	auipc	a0,0x2
ffffffffc0203b8e:	02e50513          	addi	a0,a0,46 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203b92:	fe2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203b96:	00002697          	auipc	a3,0x2
ffffffffc0203b9a:	1d268693          	addi	a3,a3,466 # ffffffffc0205d68 <default_pmm_manager+0xcb0>
ffffffffc0203b9e:	00001617          	auipc	a2,0x1
ffffffffc0203ba2:	16a60613          	addi	a2,a2,362 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203ba6:	0bd00593          	li	a1,189
ffffffffc0203baa:	00002517          	auipc	a0,0x2
ffffffffc0203bae:	00e50513          	addi	a0,a0,14 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203bb2:	fc2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203bb6:	00002697          	auipc	a3,0x2
ffffffffc0203bba:	bfa68693          	addi	a3,a3,-1030 # ffffffffc02057b0 <default_pmm_manager+0x6f8>
ffffffffc0203bbe:	00001617          	auipc	a2,0x1
ffffffffc0203bc2:	14a60613          	addi	a2,a2,330 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203bc6:	0c700593          	li	a1,199
ffffffffc0203bca:	00002517          	auipc	a0,0x2
ffffffffc0203bce:	fee50513          	addi	a0,a0,-18 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203bd2:	fa2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bd6:	00002697          	auipc	a3,0x2
ffffffffc0203bda:	19268693          	addi	a3,a3,402 # ffffffffc0205d68 <default_pmm_manager+0xcb0>
ffffffffc0203bde:	00001617          	auipc	a2,0x1
ffffffffc0203be2:	12a60613          	addi	a2,a2,298 # ffffffffc0204d08 <commands+0x738>
ffffffffc0203be6:	0fb00593          	li	a1,251
ffffffffc0203bea:	00002517          	auipc	a0,0x2
ffffffffc0203bee:	fce50513          	addi	a0,a0,-50 # ffffffffc0205bb8 <default_pmm_manager+0xb00>
ffffffffc0203bf2:	f82fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203bf6 <do_pgfault>:
...
ffffffffc0203bf6:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203bf8:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203bfa:	f022                	sd	s0,32(sp)
ffffffffc0203bfc:	ec26                	sd	s1,24(sp)
ffffffffc0203bfe:	f406                	sd	ra,40(sp)
ffffffffc0203c00:	e84a                	sd	s2,16(sp)
ffffffffc0203c02:	8432                	mv	s0,a2
ffffffffc0203c04:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c06:	8d3ff0ef          	jal	ra,ffffffffc02034d8 <find_vma>

    pgfault_num++;
ffffffffc0203c0a:	0000e797          	auipc	a5,0xe
ffffffffc0203c0e:	95e7a783          	lw	a5,-1698(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203c12:	2785                	addiw	a5,a5,1
ffffffffc0203c14:	0000e717          	auipc	a4,0xe
ffffffffc0203c18:	94f72a23          	sw	a5,-1708(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203c1c:	c159                	beqz	a0,ffffffffc0203ca2 <do_pgfault+0xac>
ffffffffc0203c1e:	651c                	ld	a5,8(a0)
ffffffffc0203c20:	08f46163          	bltu	s0,a5,ffffffffc0203ca2 <do_pgfault+0xac>
...
ffffffffc0203c24:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c26:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c28:	8b89                	andi	a5,a5,2
ffffffffc0203c2a:	ebb1                	bnez	a5,ffffffffc0203c7e <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c2c:	75fd                	lui	a1,0xfffff
...
ffffffffc0203c2e:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c30:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c32:	85a2                	mv	a1,s0
ffffffffc0203c34:	4605                	li	a2,1
ffffffffc0203c36:	a97fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203c3a:	610c                	ld	a1,0(a0)
ffffffffc0203c3c:	c1b9                	beqz	a1,ffffffffc0203c82 <do_pgfault+0x8c>
...
ffffffffc0203c42:	9127a783          	lw	a5,-1774(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203c46:	c7bd                	beqz	a5,ffffffffc0203cb4 <do_pgfault+0xbe>
...
ffffffffc0203c4a:	0030                	addi	a2,sp,8
ffffffffc0203c4c:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203c4e:	e402                	sd	zero,8(sp)
            swap_in(mm,addr,&page);
ffffffffc0203c50:	c60ff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203c54:	65a2                	ld	a1,8(sp)
ffffffffc0203c56:	6c88                	ld	a0,24(s1)
ffffffffc0203c58:	86ca                	mv	a3,s2
ffffffffc0203c5a:	8622                	mv	a2,s0
ffffffffc0203c5c:	d5bfd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm,addr,page,1);
ffffffffc0203c60:	6622                	ld	a2,8(sp)
ffffffffc0203c62:	4685                	li	a3,1
ffffffffc0203c64:	85a2                	mv	a1,s0
ffffffffc0203c66:	8526                	mv	a0,s1
ffffffffc0203c68:	b28ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
...
ffffffffc0203c6c:	67a2                	ld	a5,8(sp)
   ...
   ret = 0;
ffffffffc0203c6e:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203c70:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203c72:	70a2                	ld	ra,40(sp)
ffffffffc0203c74:	7402                	ld	s0,32(sp)
...
ffffffffc0203c80:	b775                	j	ffffffffc0203c2c <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203c82:	6c88                	ld	a0,24(s1)
ffffffffc0203c84:	864a                	mv	a2,s2
ffffffffc0203c86:	85a2                	mv	a1,s0
ffffffffc0203c88:	a39fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203c8c:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203c8e:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203c90:	f3ed                	bnez	a5,ffffffffc0203c72 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203c92:	00002517          	auipc	a0,0x2
ffffffffc0203c96:	1ce50513          	addi	a0,a0,462 # ffffffffc0205e60 <default_pmm_manager+0xda8>
ffffffffc0203c9a:	c20fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203c9e:	5571                	li	a0,-4
            goto failed;
ffffffffc0203ca0:	bfc9                	j	ffffffffc0203c72 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203ca2:	85a2                	mv	a1,s0
ffffffffc0203ca4:	00002517          	auipc	a0,0x2
ffffffffc0203ca8:	18c50513          	addi	a0,a0,396 # ffffffffc0205e30 <default_pmm_manager+0xd78>
ffffffffc0203cac:	c0efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203cb0:	5575                	li	a0,-3
        goto failed;
ffffffffc0203cb2:	b7c1                	j	ffffffffc0203c72 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203cb4:	00002517          	auipc	a0,0x2
ffffffffc0203cb8:	1d450513          	addi	a0,a0,468 # ffffffffc0205e88 <default_pmm_manager+0xdd0>
ffffffffc0203cbc:	bfefc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cc0:	5571                	li	a0,-4
            goto failed;
ffffffffc0203cc2:	bf45                	j	ffffffffc0203c72 <do_pgfault+0x7c>

ffffffffc0203cc4 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
void
swapfs_init(void) {
ffffffffc0203cc4:	1141                	addi	sp,sp,-16
    static_assert((PGSIZE % SECTSIZE) == 0);
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203cc6:	4505                	li	a0,1
swapfs_init(void) {
ffffffffc0203cc8:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203cca:	fcafc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203cce:	cd01                	beqz	a0,ffffffffc0203ce6 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203cd0:	4505                	li	a0,1
ffffffffc0203cd2:	fc8fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203cd6:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203cd8:	810d                	srli	a0,a0,0x3
ffffffffc0203cda:	0000e797          	auipc	a5,0xe
ffffffffc0203cde:	86a7b323          	sd	a0,-1946(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203ce2:	0141                	addi	sp,sp,16
ffffffffc0203ce4:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203ce6:	00002617          	auipc	a2,0x2
ffffffffc0203cea:	1ca60613          	addi	a2,a2,458 # ffffffffc0205eb0 <default_pmm_manager+0xdf8>
ffffffffc0203cee:	45b5                	li	a1,13
ffffffffc0203cf0:	00002517          	auipc	a0,0x2
ffffffffc0203cf4:	1e050513          	addi	a0,a0,480 # ffffffffc0205ed0 <default_pmm_manager+0xe18>
ffffffffc0203cf8:	e7cfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203cfc <swapfs_read>:
...
ffffffffc0203d00:	00855793          	srli	a5,a0,0x8
ffffffffc0203d04:	c3a5                	beqz	a5,ffffffffc0203d64 <swapfs_read+0x68>
ffffffffc0203d06:	0000e717          	auipc	a4,0xe
ffffffffc0203d0a:	83a73703          	ld	a4,-1990(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d0e:	04e7fb63          	bgeu	a5,a4,ffffffffc0203d64 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d12:	0000e617          	auipc	a2,0xe
ffffffffc0203d16:	81663603          	ld	a2,-2026(a2) # ffffffffc0211528 <pages>
ffffffffc0203d1a:	8d91                	sub	a1,a1,a2
ffffffffc0203d1c:	4035d613          	srai	a2,a1,0x3
ffffffffc0203d20:	00002597          	auipc	a1,0x2
ffffffffc0203d24:	4305b583          	ld	a1,1072(a1) # ffffffffc0206150 <error_string+0x38>
ffffffffc0203d28:	02b60633          	mul	a2,a2,a1
ffffffffc0203d2c:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d30:	00002797          	auipc	a5,0x2
ffffffffc0203d34:	4287b783          	ld	a5,1064(a5) # ffffffffc0206158 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d38:	0000d717          	auipc	a4,0xd
ffffffffc0203d3c:	7e873703          	ld	a4,2024(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d40:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d42:	00c61793          	slli	a5,a2,0xc
ffffffffc0203d46:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203d48:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d4a:	02e7f963          	bgeu	a5,a4,ffffffffc0203d7c <swapfs_read+0x80>
}
ffffffffc0203d4e:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d50:	0000d797          	auipc	a5,0xd
ffffffffc0203d54:	7e87b783          	ld	a5,2024(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203d5e:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d60:	f40fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203d64:	86aa                	mv	a3,a0
ffffffffc0203d66:	00002617          	auipc	a2,0x2
ffffffffc0203d6a:	18260613          	addi	a2,a2,386 # ffffffffc0205ee8 <default_pmm_manager+0xe30>
ffffffffc0203d6e:	45d1                	li	a1,20
ffffffffc0203d70:	00002517          	auipc	a0,0x2
ffffffffc0203d74:	16050513          	addi	a0,a0,352 # ffffffffc0205ed0 <default_pmm_manager+0xe18>
...
ffffffffc0203d86:	3c660613          	addi	a2,a2,966 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc0203d8a:	00001517          	auipc	a0,0x1
ffffffffc0203d8e:	38650513          	addi	a0,a0,902 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc0203d92:	de2fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d96 <swapfs_write>:
...
ffffffffc0203d9e:	c3a5                	beqz	a5,ffffffffc0203dfe <swapfs_write+0x68>
ffffffffc0203da0:	0000d717          	auipc	a4,0xd
ffffffffc0203da4:	7a073703          	ld	a4,1952(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203da8:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dfe <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203dbe:	3965b583          	ld	a1,918(a1) # ffffffffc0206150 <error_string+0x38>
ffffffffc0203dc2:	02b60633          	mul	a2,a2,a1
ffffffffc0203dc6:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203dca:	00002797          	auipc	a5,0x2
ffffffffc0203dce:	38e7b783          	ld	a5,910(a5) # ffffffffc0206158 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203de4:	02e7f963          	bgeu	a5,a4,ffffffffc0203e16 <swapfs_write+0x80>
}
...
ffffffffc0203df8:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dfa:	ecafc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203dfe:	86aa                	mv	a3,a0
ffffffffc0203e00:	00002617          	auipc	a2,0x2
ffffffffc0203e04:	0e860613          	addi	a2,a2,232 # ffffffffc0205ee8 <default_pmm_manager+0xe30>
ffffffffc0203e08:	45e5                	li	a1,25
ffffffffc0203e0a:	00002517          	auipc	a0,0x2
ffffffffc0203e0e:	0c650513          	addi	a0,a0,198 # ffffffffc0205ed0 <default_pmm_manager+0xe18>
...
ffffffffc0203e20:	32c60613          	addi	a2,a2,812 # ffffffffc0205148 <default_pmm_manager+0x90>
ffffffffc0203e24:	00001517          	auipc	a0,0x1
ffffffffc0203e28:	2ec50513          	addi	a0,a0,748 # ffffffffc0205110 <default_pmm_manager+0x58>
ffffffffc0203e2c:	d48fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e30 <printnum>:
 * */
static void
...
ffffffffc0203e30:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e34:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203e36:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e3a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203e3c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e40:	f022                	sd	s0,32(sp)
ffffffffc0203e42:	ec26                	sd	s1,24(sp)
ffffffffc0203e44:	e84a                	sd	s2,16(sp)
ffffffffc0203e46:	f406                	sd	ra,40(sp)
ffffffffc0203e48:	e44e                	sd	s3,8(sp)
ffffffffc0203e4a:	84aa                	mv	s1,a0
ffffffffc0203e4c:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203e4e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203e52:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203e54:	03067e63          	bgeu	a2,a6,ffffffffc0203e90 <printnum+0x60>
ffffffffc0203e58:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203e5a:	00805763          	blez	s0,ffffffffc0203e68 <printnum+0x38>
ffffffffc0203e5e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203e60:	85ca                	mv	a1,s2
ffffffffc0203e62:	854e                	mv	a0,s3
ffffffffc0203e64:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203e66:	fc65                	bnez	s0,ffffffffc0203e5e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e68:	1a02                	slli	s4,s4,0x20
ffffffffc0203e6a:	00002797          	auipc	a5,0x2
ffffffffc0203e6e:	09e78793          	addi	a5,a5,158 # ffffffffc0205f08 <default_pmm_manager+0xe50>
ffffffffc0203e72:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203e76:	9a3e                	add	s4,s4,a5
}
ffffffffc0203e78:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e7a:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203e7e:	70a2                	ld	ra,40(sp)
ffffffffc0203e80:	69a2                	ld	s3,8(sp)
ffffffffc0203e82:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e84:	85ca                	mv	a1,s2
ffffffffc0203e86:	87a6                	mv	a5,s1
}
ffffffffc0203e88:	6942                	ld	s2,16(sp)
ffffffffc0203e8a:	64e2                	ld	s1,24(sp)
ffffffffc0203e8c:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e8e:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203e90:	03065633          	divu	a2,a2,a6
ffffffffc0203e94:	8722                	mv	a4,s0
ffffffffc0203e96:	f9bff0ef          	jal	ra,ffffffffc0203e30 <printnum>
ffffffffc0203e9a:	b7f9                	j	ffffffffc0203e68 <printnum+0x38>

ffffffffc0203e9c <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203e9c:	7119                	addi	sp,sp,-128
ffffffffc0203e9e:	f4a6                	sd	s1,104(sp)
ffffffffc0203ea0:	f0ca                	sd	s2,96(sp)
ffffffffc0203ea2:	ecce                	sd	s3,88(sp)
ffffffffc0203ea4:	e8d2                	sd	s4,80(sp)
ffffffffc0203ea6:	e4d6                	sd	s5,72(sp)
ffffffffc0203ea8:	e0da                	sd	s6,64(sp)
ffffffffc0203eaa:	fc5e                	sd	s7,56(sp)
ffffffffc0203eac:	f06a                	sd	s10,32(sp)
ffffffffc0203eae:	fc86                	sd	ra,120(sp)
ffffffffc0203eb0:	f8a2                	sd	s0,112(sp)
ffffffffc0203eb2:	f862                	sd	s8,48(sp)
ffffffffc0203eb4:	f466                	sd	s9,40(sp)
ffffffffc0203eb6:	ec6e                	sd	s11,24(sp)
ffffffffc0203eb8:	892a                	mv	s2,a0
ffffffffc0203eba:	84ae                	mv	s1,a1
ffffffffc0203ebc:	8d32                	mv	s10,a2
ffffffffc0203ebe:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203ec0:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203ec4:	5b7d                	li	s6,-1
ffffffffc0203ec6:	00002a97          	auipc	s5,0x2
ffffffffc0203eca:	076a8a93          	addi	s5,s5,118 # ffffffffc0205f3c <default_pmm_manager+0xe84>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203ece:	00002b97          	auipc	s7,0x2
ffffffffc0203ed2:	24ab8b93          	addi	s7,s7,586 # ffffffffc0206118 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203ed6:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203eda:	001d0413          	addi	s0,s10,1
ffffffffc0203ede:	01350a63          	beq	a0,s3,ffffffffc0203ef2 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203ee2:	c121                	beqz	a0,ffffffffc0203f22 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0203eee:	ff351ae3          	bne	a0,s3,ffffffffc0203ee2 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ef2:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203ef6:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203efa:	4c81                	li	s9,0
ffffffffc0203efc:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203efe:	5c7d                	li	s8,-1
ffffffffc0203f00:	5dfd                	li	s11,-1
ffffffffc0203f02:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f06:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f08:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f0c:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f10:	00140d13          	addi	s10,s0,1
ffffffffc0203f14:	04b56263          	bltu	a0,a1,ffffffffc0203f58 <vprintfmt+0xbc>
ffffffffc0203f18:	058a                	slli	a1,a1,0x2
ffffffffc0203f1a:	95d6                	add	a1,a1,s5
ffffffffc0203f1c:	4194                	lw	a3,0(a1)
ffffffffc0203f1e:	96d6                	add	a3,a3,s5
...
ffffffffc0203f3e:	8082                	ret
            padc = '0';
ffffffffc0203f40:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203f42:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f46:	846a                	mv	s0,s10
ffffffffc0203f48:	00140d13          	addi	s10,s0,1
ffffffffc0203f4c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f50:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f54:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f18 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203f58:	85a6                	mv	a1,s1
ffffffffc0203f5a:	02500513          	li	a0,37
ffffffffc0203f5e:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203f60:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203f64:	8d22                	mv	s10,s0
ffffffffc0203f66:	f73788e3          	beq	a5,s3,ffffffffc0203ed6 <vprintfmt+0x3a>
ffffffffc0203f6a:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203f6e:	1d7d                	addi	s10,s10,-1
ffffffffc0203f70:	ff379de3          	bne	a5,s3,ffffffffc0203f6a <vprintfmt+0xce>
ffffffffc0203f74:	b78d                	j	ffffffffc0203ed6 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203f76:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203f7a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f7e:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203f80:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203f84:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203f88:	02d86463          	bltu	a6,a3,ffffffffc0203fb0 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203f8c:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203f90:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203f94:	0186873b          	addw	a4,a3,s8
ffffffffc0203f98:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203f9c:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203f9e:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203fa2:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203fa4:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203fa8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fac:	fed870e3          	bgeu	a6,a3,ffffffffc0203f8c <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203fb0:	f40ddce3          	bgez	s11,ffffffffc0203f08 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203fb4:	8de2                	mv	s11,s8
ffffffffc0203fb6:	5c7d                	li	s8,-1
ffffffffc0203fb8:	bf81                	j	ffffffffc0203f08 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203fba:	fffdc693          	not	a3,s11
ffffffffc0203fbe:	96fd                	srai	a3,a3,0x3f
ffffffffc0203fc0:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fc4:	00144603          	lbu	a2,1(s0)
ffffffffc0203fc8:	2d81                	sext.w	s11,s11
ffffffffc0203fca:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203fcc:	bf35                	j	ffffffffc0203f08 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203fce:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fd2:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203fd6:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fd8:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203fda:	bfd9                	j	ffffffffc0203fb0 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203fdc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203fde:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203fe2:	01174463          	blt	a4,a7,ffffffffc0203fea <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203fe6:	1a088e63          	beqz	a7,ffffffffc02041a2 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203fea:	000a3603          	ld	a2,0(s4)
ffffffffc0203fee:	46c1                	li	a3,16
ffffffffc0203ff0:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203ff2:	2781                	sext.w	a5,a5
ffffffffc0203ff4:	876e                	mv	a4,s11
ffffffffc0203ff6:	85a6                	mv	a1,s1
ffffffffc0203ff8:	854a                	mv	a0,s2
ffffffffc0203ffa:	e37ff0ef          	jal	ra,ffffffffc0203e30 <printnum>
            break;
ffffffffc0203ffe:	bde1                	j	ffffffffc0203ed6 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204000:	000a2503          	lw	a0,0(s4)
ffffffffc0204004:	85a6                	mv	a1,s1
ffffffffc0204006:	0a21                	addi	s4,s4,8
ffffffffc0204008:	9902                	jalr	s2
            break;
ffffffffc020400a:	b5f1                	j	ffffffffc0203ed6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020400c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020400e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204012:	01174463          	blt	a4,a7,ffffffffc020401a <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204016:	18088163          	beqz	a7,ffffffffc0204198 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020401a:	000a3603          	ld	a2,0(s4)
ffffffffc020401e:	46a9                	li	a3,10
ffffffffc0204020:	8a2e                	mv	s4,a1
ffffffffc0204022:	bfc1                	j	ffffffffc0203ff2 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204024:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204028:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020402a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020402c:	bdf1                	j	ffffffffc0203f08 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc020402e:	85a6                	mv	a1,s1
ffffffffc0204030:	02500513          	li	a0,37
ffffffffc0204034:	9902                	jalr	s2
            break;
ffffffffc0204036:	b545                	j	ffffffffc0203ed6 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204038:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020403c:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020403e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204040:	b5e1                	j	ffffffffc0203f08 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204042:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204044:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204048:	01174463          	blt	a4,a7,ffffffffc0204050 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020404c:	14088163          	beqz	a7,ffffffffc020418e <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204050:	000a3603          	ld	a2,0(s4)
ffffffffc0204054:	46a1                	li	a3,8
ffffffffc0204056:	8a2e                	mv	s4,a1
ffffffffc0204058:	bf69                	j	ffffffffc0203ff2 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020405a:	03000513          	li	a0,48
ffffffffc020405e:	85a6                	mv	a1,s1
ffffffffc0204060:	e03e                	sd	a5,0(sp)
ffffffffc0204062:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204064:	85a6                	mv	a1,s1
ffffffffc0204066:	07800513          	li	a0,120
ffffffffc020406a:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020406c:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc020406e:	6782                	ld	a5,0(sp)
ffffffffc0204070:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204072:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204076:	bfb5                	j	ffffffffc0203ff2 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204078:	000a3403          	ld	s0,0(s4)
ffffffffc020407c:	008a0713          	addi	a4,s4,8
ffffffffc0204080:	e03a                	sd	a4,0(sp)
ffffffffc0204082:	14040263          	beqz	s0,ffffffffc02041c6 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204086:	0fb05763          	blez	s11,ffffffffc0204174 <vprintfmt+0x2d8>
ffffffffc020408a:	02d00693          	li	a3,45
ffffffffc020408e:	0cd79163          	bne	a5,a3,ffffffffc0204150 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204092:	00044783          	lbu	a5,0(s0)
ffffffffc0204096:	0007851b          	sext.w	a0,a5
ffffffffc020409a:	cf85                	beqz	a5,ffffffffc02040d2 <vprintfmt+0x236>
ffffffffc020409c:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040a0:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040a4:	000c4563          	bltz	s8,ffffffffc02040ae <vprintfmt+0x212>
ffffffffc02040a8:	3c7d                	addiw	s8,s8,-1
ffffffffc02040aa:	036c0263          	beq	s8,s6,ffffffffc02040ce <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02040ae:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040b0:	0e0c8e63          	beqz	s9,ffffffffc02041ac <vprintfmt+0x310>
ffffffffc02040b4:	3781                	addiw	a5,a5,-32
ffffffffc02040b6:	0ef47b63          	bgeu	s0,a5,ffffffffc02041ac <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02040ba:	03f00513          	li	a0,63
ffffffffc02040be:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040c0:	000a4783          	lbu	a5,0(s4)
ffffffffc02040c4:	3dfd                	addiw	s11,s11,-1
ffffffffc02040c6:	0a05                	addi	s4,s4,1
ffffffffc02040c8:	0007851b          	sext.w	a0,a5
ffffffffc02040cc:	ffe1                	bnez	a5,ffffffffc02040a4 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02040ce:	01b05963          	blez	s11,ffffffffc02040e0 <vprintfmt+0x244>
...
ffffffffc02040da:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02040dc:	fe0d9be3          	bnez	s11,ffffffffc02040d2 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040e0:	6a02                	ld	s4,0(sp)
ffffffffc02040e2:	bbd5                	j	ffffffffc0203ed6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02040e4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040e6:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02040ea:	01174463          	blt	a4,a7,ffffffffc02040f2 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02040ee:	08088d63          	beqz	a7,ffffffffc0204188 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02040f2:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02040f6:	0a044d63          	bltz	s0,ffffffffc02041b0 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02040fa:	8622                	mv	a2,s0
ffffffffc02040fc:	8a66                	mv	s4,s9
ffffffffc02040fe:	46a9                	li	a3,10
ffffffffc0204100:	bdcd                	j	ffffffffc0203ff2 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204102:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204106:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204108:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020410a:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc020410e:	8fb5                	xor	a5,a5,a3
ffffffffc0204110:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204114:	02d74163          	blt	a4,a3,ffffffffc0204136 <vprintfmt+0x29a>
ffffffffc0204118:	00369793          	slli	a5,a3,0x3
ffffffffc020411c:	97de                	add	a5,a5,s7
ffffffffc020411e:	639c                	ld	a5,0(a5)
ffffffffc0204120:	cb99                	beqz	a5,ffffffffc0204136 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204122:	86be                	mv	a3,a5
ffffffffc0204124:	00002617          	auipc	a2,0x2
ffffffffc0204128:	e1460613          	addi	a2,a2,-492 # ffffffffc0205f38 <default_pmm_manager+0xe80>
ffffffffc020412c:	85a6                	mv	a1,s1
ffffffffc020412e:	854a                	mv	a0,s2
ffffffffc0204130:	0ce000ef          	jal	ra,ffffffffc02041fe <printfmt>
ffffffffc0204134:	b34d                	j	ffffffffc0203ed6 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204136:	00002617          	auipc	a2,0x2
ffffffffc020413a:	df260613          	addi	a2,a2,-526 # ffffffffc0205f28 <default_pmm_manager+0xe70>
ffffffffc020413e:	85a6                	mv	a1,s1
ffffffffc0204140:	854a                	mv	a0,s2
ffffffffc0204142:	0bc000ef          	jal	ra,ffffffffc02041fe <printfmt>
ffffffffc0204146:	bb41                	j	ffffffffc0203ed6 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204148:	00002417          	auipc	s0,0x2
ffffffffc020414c:	dd840413          	addi	s0,s0,-552 # ffffffffc0205f20 <default_pmm_manager+0xe68>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204150:	85e2                	mv	a1,s8
ffffffffc0204152:	8522                	mv	a0,s0
ffffffffc0204154:	e43e                	sd	a5,8(sp)
ffffffffc0204156:	196000ef          	jal	ra,ffffffffc02042ec <strnlen>
ffffffffc020415a:	40ad8dbb          	subw	s11,s11,a0
ffffffffc020415e:	01b05b63          	blez	s11,ffffffffc0204174 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204162:	67a2                	ld	a5,8(sp)
ffffffffc0204164:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
...
ffffffffc020416e:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204170:	fe0d9ce3          	bnez	s11,ffffffffc0204168 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204174:	00044783          	lbu	a5,0(s0)
ffffffffc0204178:	00140a13          	addi	s4,s0,1
ffffffffc020417c:	0007851b          	sext.w	a0,a5
ffffffffc0204180:	d3a5                	beqz	a5,ffffffffc02040e0 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204182:	05e00413          	li	s0,94
ffffffffc0204186:	bf39                	j	ffffffffc02040a4 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204188:	000a2403          	lw	s0,0(s4)
ffffffffc020418c:	b7ad                	j	ffffffffc02040f6 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc020418e:	000a6603          	lwu	a2,0(s4)
ffffffffc0204192:	46a1                	li	a3,8
ffffffffc0204194:	8a2e                	mv	s4,a1
ffffffffc0204196:	bdb1                	j	ffffffffc0203ff2 <vprintfmt+0x156>
ffffffffc0204198:	000a6603          	lwu	a2,0(s4)
ffffffffc020419c:	46a9                	li	a3,10
ffffffffc020419e:	8a2e                	mv	s4,a1
ffffffffc02041a0:	bd89                	j	ffffffffc0203ff2 <vprintfmt+0x156>
ffffffffc02041a2:	000a6603          	lwu	a2,0(s4)
ffffffffc02041a6:	46c1                	li	a3,16
ffffffffc02041a8:	8a2e                	mv	s4,a1
ffffffffc02041aa:	b5a1                	j	ffffffffc0203ff2 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02041ac:	9902                	jalr	s2
ffffffffc02041ae:	bf09                	j	ffffffffc02040c0 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02041b0:	85a6                	mv	a1,s1
ffffffffc02041b2:	02d00513          	li	a0,45
ffffffffc02041b6:	e03e                	sd	a5,0(sp)
ffffffffc02041b8:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02041ba:	6782                	ld	a5,0(sp)
ffffffffc02041bc:	8a66                	mv	s4,s9
ffffffffc02041be:	40800633          	neg	a2,s0
ffffffffc02041c2:	46a9                	li	a3,10
ffffffffc02041c4:	b53d                	j	ffffffffc0203ff2 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02041c6:	03b05163          	blez	s11,ffffffffc02041e8 <vprintfmt+0x34c>
ffffffffc02041ca:	02d00693          	li	a3,45
ffffffffc02041ce:	f6d79de3          	bne	a5,a3,ffffffffc0204148 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02041d2:	00002417          	auipc	s0,0x2
ffffffffc02041d6:	d4e40413          	addi	s0,s0,-690 # ffffffffc0205f20 <default_pmm_manager+0xe68>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041da:	02800793          	li	a5,40
ffffffffc02041de:	02800513          	li	a0,40
ffffffffc02041e2:	00140a13          	addi	s4,s0,1
ffffffffc02041e6:	bd6d                	j	ffffffffc02040a0 <vprintfmt+0x204>
ffffffffc02041e8:	00002a17          	auipc	s4,0x2
ffffffffc02041ec:	d39a0a13          	addi	s4,s4,-711 # ffffffffc0205f21 <default_pmm_manager+0xe69>
ffffffffc02041f0:	02800513          	li	a0,40
ffffffffc02041f4:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041f8:	05e00413          	li	s0,94
ffffffffc02041fc:	b565                	j	ffffffffc02040a4 <vprintfmt+0x208>

ffffffffc02041fe <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02041fe:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204200:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204204:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204206:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204208:	ec06                	sd	ra,24(sp)
ffffffffc020420a:	f83a                	sd	a4,48(sp)
ffffffffc020420c:	fc3e                	sd	a5,56(sp)
ffffffffc020420e:	e0c2                	sd	a6,64(sp)
ffffffffc0204210:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204212:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204214:	c89ff0ef          	jal	ra,ffffffffc0203e9c <vprintfmt>
}
ffffffffc0204218:	60e2                	ld	ra,24(sp)
ffffffffc020421a:	6161                	addi	sp,sp,80
ffffffffc020421c:	8082                	ret

ffffffffc020421e <readline>:
...
ffffffffc020421e:	715d                	addi	sp,sp,-80
ffffffffc0204220:	e486                	sd	ra,72(sp)
ffffffffc0204222:	e0a6                	sd	s1,64(sp)
ffffffffc0204224:	fc4a                	sd	s2,56(sp)
ffffffffc0204226:	f84e                	sd	s3,48(sp)
ffffffffc0204228:	f452                	sd	s4,40(sp)
ffffffffc020422a:	f056                	sd	s5,32(sp)
ffffffffc020422c:	ec5a                	sd	s6,24(sp)
ffffffffc020422e:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204230:	c901                	beqz	a0,ffffffffc0204240 <readline+0x22>
ffffffffc0204232:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204234:	00002517          	auipc	a0,0x2
ffffffffc0204238:	d0450513          	addi	a0,a0,-764 # ffffffffc0205f38 <default_pmm_manager+0xe80>
ffffffffc020423c:	e7ffb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc020424e:	eaeb8b93          	addi	s7,s7,-338 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204252:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0204256:	e9dfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020425a:	00054a63          	bltz	a0,ffffffffc020426e <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020425e:	00a95a63          	bge	s2,a0,ffffffffc0204272 <readline+0x54>
ffffffffc0204262:	029a5263          	bge	s4,s1,ffffffffc0204286 <readline+0x68>
        c = getchar();
ffffffffc0204266:	e8dfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020426a:	fe055ae3          	bgez	a0,ffffffffc020425e <readline+0x40>
            return NULL;
ffffffffc020426e:	4501                	li	a0,0
ffffffffc0204270:	a091                	j	ffffffffc02042b4 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc0204272:	03351463          	bne	a0,s3,ffffffffc020429a <readline+0x7c>
ffffffffc0204276:	e8a9                	bnez	s1,ffffffffc02042c8 <readline+0xaa>
        c = getchar();
ffffffffc0204278:	e7bfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020427c:	fe0549e3          	bltz	a0,ffffffffc020426e <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204280:	fea959e3          	bge	s2,a0,ffffffffc0204272 <readline+0x54>
ffffffffc0204284:	4481                	li	s1,0
            cputchar(c);
ffffffffc0204286:	e42a                	sd	a0,8(sp)
ffffffffc0204288:	e69fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc020428c:	6522                	ld	a0,8(sp)
ffffffffc020428e:	009b87b3          	add	a5,s7,s1
ffffffffc0204292:	2485                	addiw	s1,s1,1
ffffffffc0204294:	00a78023          	sb	a0,0(a5)
ffffffffc0204298:	bf7d                	j	ffffffffc0204256 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc020429a:	01550463          	beq	a0,s5,ffffffffc02042a2 <readline+0x84>
ffffffffc020429e:	fb651ce3          	bne	a0,s6,ffffffffc0204256 <readline+0x38>
            cputchar(c);
ffffffffc02042a2:	e4ffb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc02042a6:	0000d517          	auipc	a0,0xd
ffffffffc02042aa:	e5250513          	addi	a0,a0,-430 # ffffffffc02110f8 <buf>
ffffffffc02042ae:	94aa                	add	s1,s1,a0
ffffffffc02042b0:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02042b4:	60a6                	ld	ra,72(sp)
ffffffffc02042b6:	6486                	ld	s1,64(sp)
ffffffffc02042b8:	7962                	ld	s2,56(sp)
ffffffffc02042ba:	79c2                	ld	s3,48(sp)
ffffffffc02042bc:	7a22                	ld	s4,40(sp)
ffffffffc02042be:	7a82                	ld	s5,32(sp)
ffffffffc02042c0:	6b62                	ld	s6,24(sp)
ffffffffc02042c2:	6bc2                	ld	s7,16(sp)
ffffffffc02042c4:	6161                	addi	sp,sp,80
ffffffffc02042c6:	8082                	ret
            cputchar(c);
ffffffffc02042c8:	4521                	li	a0,8
ffffffffc02042ca:	e27fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc02042ce:	34fd                	addiw	s1,s1,-1
ffffffffc02042d0:	b759                	j	ffffffffc0204256 <readline+0x38>

ffffffffc02042d2 <strlen>:
...
strlen(const char *s) {
ffffffffc02042d6:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02042d8:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02042da:	cb81                	beqz	a5,ffffffffc02042ea <strlen+0x18>
        cnt ++;
ffffffffc02042dc:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02042de:	00a707b3          	add	a5,a4,a0
ffffffffc02042e2:	0007c783          	lbu	a5,0(a5)
ffffffffc02042e6:	fbfd                	bnez	a5,ffffffffc02042dc <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc02042ec:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc02042ee:	e589                	bnez	a1,ffffffffc02042f8 <strnlen+0xc>
ffffffffc02042f0:	a811                	j	ffffffffc0204304 <strnlen+0x18>
        cnt ++;
ffffffffc02042f2:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02042f4:	00f58863          	beq	a1,a5,ffffffffc0204304 <strnlen+0x18>
ffffffffc02042f8:	00f50733          	add	a4,a0,a5
ffffffffc02042fc:	00074703          	lbu	a4,0(a4)
ffffffffc0204300:	fb6d                	bnez	a4,ffffffffc02042f2 <strnlen+0x6>
ffffffffc0204302:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204304:	852e                	mv	a0,a1
ffffffffc0204306:	8082                	ret

ffffffffc0204308 <strcpy>:
char *
...
ffffffffc0204316:	fb75                	bnez	a4,ffffffffc020430a <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc020431e:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204322:	cb89                	beqz	a5,ffffffffc0204334 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204324:	0505                	addi	a0,a0,1
ffffffffc0204326:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204328:	fee789e3          	beq	a5,a4,ffffffffc020431a <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020432c:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204330:	9d19                	subw	a0,a0,a4
ffffffffc0204332:	8082                	ret
ffffffffc0204334:	4501                	li	a0,0
ffffffffc0204336:	bfed                	j	ffffffffc0204330 <strcmp+0x16>

ffffffffc0204338 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204338:	00054783          	lbu	a5,0(a0)
ffffffffc020433c:	c799                	beqz	a5,ffffffffc020434a <strchr+0x12>
        if (*s == c) {
ffffffffc020433e:	00f58763          	beq	a1,a5,ffffffffc020434c <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204342:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204346:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204348:	fbfd                	bnez	a5,ffffffffc020433e <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc020434e:	ca01                	beqz	a2,ffffffffc020435e <memset+0x10>
ffffffffc0204350:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204352:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204354:	0785                	addi	a5,a5,1
ffffffffc0204356:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020435a:	fec79de3          	bne	a5,a2,ffffffffc0204354 <memset+0x6>
    }
    return s;
...
ffffffffc0204360 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204360:	ca19                	beqz	a2,ffffffffc0204376 <memcpy+0x16>
ffffffffc0204362:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204364:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204366:	0005c703          	lbu	a4,0(a1)
ffffffffc020436a:	0585                	addi	a1,a1,1
ffffffffc020436c:	0785                	addi	a5,a5,1
ffffffffc020436e:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204372:	fec59ae3          	bne	a1,a2,ffffffffc0204366 <memcpy+0x6>
    }
    return dst;
