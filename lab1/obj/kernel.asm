...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003ce:	08f76e63          	bltu	a4,a5,8020046a <interrupt_handler+0xa6>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200416:	00004717          	auipc	a4,0x4
    8020041a:	bfa70713          	addi	a4,a4,-1030 # 80204010 <ticks>
    8020041e:	631c                	ld	a5,0(a4)
    80200420:	00004417          	auipc	s0,0x4
    80200424:	bf840413          	addi	s0,s0,-1032 # 80204018 <num>
    80200428:	0785                	addi	a5,a5,1
    8020042a:	e31c                	sd	a5,0(a4)
    8020042c:	c395                	beqz	a5,80200450 <interrupt_handler+0x8c>
    8020042e:	631c                	ld	a5,0(a4)
    80200430:	06400713          	li	a4,100
    80200434:	02e7f7b3          	remu	a5,a5,a4
    80200438:	ef81                	bnez	a5,80200450 <interrupt_handler+0x8c>
    cprintf("%d ticks\n", TICK_NUM);
    8020043a:	06400593          	li	a1,100
    8020043e:	00001517          	auipc	a0,0x1
    80200442:	afa50513          	addi	a0,a0,-1286 # 80200f38 <etext+0x510>
    80200446:	c2bff0ef          	jal	ra,80200070 <cprintf>
            	print_ticks();
            	num++;
    8020044a:	601c                	ld	a5,0(s0)
    8020044c:	0785                	addi	a5,a5,1
    8020044e:	e01c                	sd	a5,0(s0)
            }
            if(num==10){
    80200450:	6018                	ld	a4,0(s0)
    80200452:	47a9                	li	a5,10
    80200454:	00f70c63          	beq	a4,a5,8020046c <interrupt_handler+0xa8>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200464:	ae850513          	addi	a0,a0,-1304 # 80200f48 <etext+0x520>
    80200468:	b121                	j	80200070 <cprintf>
            print_trapframe(tf);
    8020046a:	bded                	j	80200364 <print_trapframe>
}
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005fc:	a3078793          	addi	a5,a5,-1488 # 80201028 <etext+0x600>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200658:	a08a8a93          	addi	s5,s5,-1528 # 8020105c <etext+0x634>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200660:	bdcb8b93          	addi	s7,s7,-1060 # 80201238 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008b6:	7a660613          	addi	a2,a2,1958 # 80201058 <etext+0x630>
    ...
    802008c8:	78460613          	addi	a2,a2,1924 # 80201048 <etext+0x620>
    ...
    802008da:	76a40413          	addi	s0,s0,1898 # 80201040 <etext+0x618>
    ...
    80200964:	6e040413          	addi	s0,s0,1760 # 80201040 <etext+0x618>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    8020097a:	6cba0a13          	addi	s4,s4,1739 # 80201041 <etext+0x619>
