...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003c8:	08f76e63          	bltu	a4,a5,80200464 <interrupt_handler+0xa6>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200424:	e31c                	sd	a5,0(a4)
    80200426:	c395                	beqz	a5,8020044a <interrupt_handler+0x8c>
    80200428:	631c                	ld	a5,0(a4)
    8020042a:	06400713          	li	a4,100
    8020042e:	02e7f7b3          	remu	a5,a5,a4
    80200432:	ef81                	bnez	a5,8020044a <interrupt_handler+0x8c>
    cprintf("%d ticks\n", TICK_NUM);
    80200434:	06400593          	li	a1,100
    80200438:	00001517          	auipc	a0,0x1
    8020043c:	b0050513          	addi	a0,a0,-1280 # 80200f38 <etext+0x514>
    80200440:	c2bff0ef          	jal	ra,8020006a <cprintf>
            	print_ticks();
            	num++;
    80200444:	601c                	ld	a5,0(s0)
    80200446:	0785                	addi	a5,a5,1
    80200448:	e01c                	sd	a5,0(s0)
            }
            if(num==10){
    8020044a:	6018                	ld	a4,0(s0)
    8020044c:	47a9                	li	a5,10
    8020044e:	00f70c63          	beq	a4,a5,80200466 <interrupt_handler+0xa8>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200454:	6402                	ld	s0,0(sp)
    80200456:	0141                	addi	sp,sp,16
    80200458:	8082                	ret
            cprintf("Supervisor external interrupt\n");
    8020045a:	00001517          	auipc	a0,0x1
    8020045e:	aee50513          	addi	a0,a0,-1298 # 80200f48 <etext+0x524>
    80200462:	b121                	j	8020006a <cprintf>
            print_trapframe(tf);
    80200464:	bded                	j	8020035e <print_trapframe>
}
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005f8:	a2c78793          	addi	a5,a5,-1492 # 80201020 <etext+0x5fc>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200654:	a04a8a93          	addi	s5,s5,-1532 # 80201054 <etext+0x630>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    8020065c:	bd8b8b93          	addi	s7,s7,-1064 # 80201230 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008b2:	7a260613          	addi	a2,a2,1954 # 80201050 <etext+0x62c>
    ...
    802008c4:	78060613          	addi	a2,a2,1920 # 80201040 <etext+0x61c>
    ...
    802008d6:	76640413          	addi	s0,s0,1894 # 80201038 <etext+0x614>
    ...
    80200960:	6dc40413          	addi	s0,s0,1756 # 80201038 <etext+0x614>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200976:	6c7a0a13          	addi	s4,s4,1735 # 80201039 <etext+0x615>
